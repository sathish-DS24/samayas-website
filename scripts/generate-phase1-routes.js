...
// Helper to determine seasonality and road conditions
function getRouteMetadata(r) {
  const isHill = ['ooty', 'kodaikanal', 'munnar', 'valparai', 'coonoor'].some(h => r.slug.includes(h));
  const isPilgrimage = ['velankanni', 'rameswaram', 'tirupati', 'kumbakonam', 'chidambaram', 'tiruchendur', 'mahabalipuram'].some(p => r.slug.includes(p));

  const seasonality = isHill
    ? ['Summer', 'Winter']
    : isPilgrimage
    ? ['Festival', 'Winter', 'All Season']
    : ['All Season'];

  const roadConditions = isHill
    ? `Scenic mountain ghat road with hairpin bends. Driver certified in hill gear control.`
    : r.hw[0].includes('ECR')
    ? `Coastal 2-lane ECR highway featuring scenic Bay of Bengal views and smooth road surface.`
    : `Access-controlled ${r.hw[0]} multi-lane toll expressway with high-speed bypasses around towns.`;
...
const phase1Routes = [
  // ── MAJOR CITIES (`City`) ──
  { slug: 'trichy-to-chennai', from: 'Trichy', to: 'Chennai', category: 'City', popularity: 10, isFeatured: true, purposes: ['Business', 'Medical', 'Airport'], origin: 'tiruchirappalli', dest: 'chennai', dist: 330, time: 5.5, hw: ['NH38', 'NH45 GST Road'], toll: '₹420 - ₹520', tollCount: 4 },
  { slug: 'chennai-to-trichy', from: 'Chennai', to: 'Trichy', category: 'City', popularity: 10, isFeatured: true, purposes: ['Home Visit', 'Business', 'Temple'], origin: 'chennai', dest: 'tiruchirappalli', dist: 330, time: 5.5, hw: ['NH45 GST Road', 'NH38'], toll: '₹420 - ₹520', tollCount: 4 },
  ...
  { slug: 'tirunelveli-to-chennai', from: 'Tirunelveli', to: 'Chennai', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Education', 'Airport'], origin: 'tirunelveli', dest: 'chennai', dist: 620, time: 10.0, hw: ['NH44', 'NH45'], toll: '₹750 - ₹880', tollCount: 9 },
  { slug: 'chennai-to-thanjavur', from: 'Chennai', to: 'Thanjavur', category: 'City', popularity: 9, isFeatured: true, purposes: ['Heritage', 'Pilgrimage', 'Family'], origin: 'chennai', dest: 'thanjavur', dist: 340, time: 6.0, hw: ['NH45', 'NH36'], toll: '₹420 - ₹500', tollCount: 4 },
  { slug: 'thanjavur-to-chennai', from: 'Thanjavur', to: 'Chennai', category: 'City', popularity: 9, isFeatured: false, purposes: ['Medical', 'Business', 'Airport'], origin: 'thanjavur', dest: 'chennai', dist: 340, time: 6.0, hw: ['NH36', 'NH45'], toll: '₹420 - ₹500', tollCount: 4 },
  { slug: 'chennai-to-vellore', from: 'Chennai', to: 'Vellore', category: 'City', popularity: 9, isFeatured: true, purposes: ['Medical', 'CMC Hospital', 'Education'], origin: 'chennai', dest: 'vellore', dist: 140, time: 2.75, hw: ['NH48'], toll: '₹140 - ₹180', tollCount: 2 },
  { slug: 'vellore-to-chennai', from: 'Vellore', to: 'Chennai', category: 'City', popularity: 9, isFeatured: false, purposes: ['Medical', 'Airport', 'Business'], origin: 'vellore', dest: 'chennai', dist: 140, time: 2.75, hw: ['NH48'], toll: '₹140 - ₹180', tollCount: 2 },
  { slug: 'chennai-to-erode', from: 'Chennai', to: 'Erode', category: 'City', popularity: 8, isFeatured: false, purposes: ['Textile', 'Business'], origin: 'chennai', dest: 'erode', dist: 420, time: 7.0, hw: ['NH48', 'NH544'], toll: '₹520 - ₹620', tollCount: 6 },
  { slug: 'erode-to-chennai', from: 'Erode', to: 'Chennai', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Medical', 'Airport'], origin: 'erode', dest: 'chennai', dist: 420, time: 7.0, hw: ['NH544', 'NH48'], toll: '₹520 - ₹620', tollCount: 6 },
  { slug: 'chennai-to-nagapattinam', from: 'Chennai', to: 'Nagapattinam', category: 'City', popularity: 8, isFeatured: false, purposes: ['Coastal', 'Port', 'Pilgrimage'], origin: 'chennai', dest: 'nagapattinam', dist: 310, time: 6.0, hw: ['ECR', 'NH32'], toll: '₹320 - ₹410', tollCount: 4 },
  { slug: 'nagapattinam-to-chennai', from: 'Nagapattinam', to: 'Chennai', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Medical', 'Airport'], origin: 'nagapattinam', dest: 'chennai', dist: 310, time: 6.0, hw: ['NH32', 'ECR'], toll: '₹320 - ₹410', tollCount: 4 },

  { slug: 'trichy-to-madurai', from: 'Trichy', to: 'Madurai', category: 'City', popularity: 9, isFeatured: true, purposes: ['Business', 'Temple', 'Airport'], origin: 'tiruchirappalli', dest: 'madurai', dist: 135, time: 2.25, hw: ['NH38'], toll: '₹140 - ₹180', tollCount: 2 },
  { slug: 'madurai-to-trichy', from: 'Madurai', to: 'Trichy', category: 'City', popularity: 9, isFeatured: false, purposes: ['Business', 'TRZ Airport', 'Temple'], origin: 'madurai', dest: 'tiruchirappalli', dist: 135, time: 2.25, hw: ['NH38'], toll: '₹140 - ₹180', tollCount: 2 },
  { slug: 'trichy-to-coimbatore', from: 'Trichy', to: 'Coimbatore', category: 'City', popularity: 9, isFeatured: true, purposes: ['Business', 'Industrial', 'Textile'], origin: 'tiruchirappalli', dest: 'coimbatore', dist: 215, time: 4.25, hw: ['NH81'], toll: '₹180 - ₹240', tollCount: 2 },
  { slug: 'coimbatore-to-trichy', from: 'Coimbatore', to: 'Trichy', category: 'City', popularity: 9, isFeatured: false, purposes: ['Business', 'TRZ Airport', 'Education'], origin: 'coimbatore', dest: 'tiruchirappalli', dist: 215, time: 4.25, hw: ['NH81'], toll: '₹180 - ₹240', tollCount: 2 },
  { slug: 'trichy-to-salem', from: 'Trichy', to: 'Salem', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Transit'], origin: 'tiruchirappalli', dest: 'salem', dist: 140, time: 2.75, hw: ['NH81', 'NH44'], toll: '₹120 - ₹160', tollCount: 2 },
  { slug: 'salem-to-trichy', from: 'Salem', to: 'Trichy', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'TRZ Airport'], origin: 'salem', dest: 'tiruchirappalli', dist: 140, time: 2.75, hw: ['NH44', 'NH81'], toll: '₹120 - ₹160', tollCount: 2 },
  { slug: 'trichy-to-thanjavur', from: 'Trichy', to: 'Thanjavur', category: 'City', popularity: 9, isFeatured: true, purposes: ['Commute', 'Tourism', 'Heritage'], origin: 'tiruchirappalli', dest: 'thanjavur', dist: 55, time: 1.0, hw: ['NH83'], toll: '₹40 - ₹70', tollCount: 1 },
  { slug: 'thanjavur-to-trichy', from: 'Thanjavur', to: 'Trichy', category: 'City', popularity: 9, isFeatured: false, purposes: ['TRZ Airport', 'Medical', 'Shopping'], origin: 'thanjavur', dest: 'tiruchirappalli', dist: 55, time: 1.0, hw: ['NH83'], toll: '₹40 - ₹70', tollCount: 1 },
  { slug: 'trichy-to-tirunelveli', from: 'Trichy', to: 'Tirunelveli', category: 'City', popularity: 8, isFeatured: false, purposes: ['Family', 'Business'], origin: 'tiruchirappalli', dest: 'tirunelveli', dist: 290, time: 4.75, hw: ['NH38', 'NH44'], toll: '₹340 - ₹420', tollCount: 4 },
  { slug: 'tirunelveli-to-trichy', from: 'Tirunelveli', to: 'Trichy', category: 'City', popularity: 8, isFeatured: false, purposes: ['TRZ Airport', 'Education'], origin: 'tirunelveli', dest: 'tiruchirappalli', dist: 290, time: 4.75, hw: ['NH44', 'NH38'], toll: '₹340 - ₹420', tollCount: 4 },
  { slug: 'trichy-to-erode', from: 'Trichy', to: 'Erode', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Textile'], origin: 'tiruchirappalli', dest: 'erode', dist: 155, time: 3.25, hw: ['NH81'], toll: '₹110 - ₹150', tollCount: 2 },
  { slug: 'erode-to-trichy', from: 'Erode', to: 'Trichy', category: 'City', popularity: 8, isFeatured: false, purposes: ['TRZ Airport', 'Medical'], origin: 'erode', dest: 'tiruchirappalli', dist: 155, time: 3.25, hw: ['NH81'], toll: '₹110 - ₹150', tollCount: 2 },

  { slug: 'madurai-to-coimbatore', from: 'Madurai', to: 'Coimbatore', category: 'City', popularity: 9, isFeatured: true, purposes: ['Business', 'Industrial', 'Medical'], origin: 'madurai', dest: 'coimbatore', dist: 210, time: 4.25, hw: ['NH83'], toll: '₹160 - ₹220', tollCount: 2 },
  { slug: 'coimbatore-to-madurai', from: 'Coimbatore', to: 'Madurai', category: 'City', popularity: 9, isFeatured: false, purposes: ['Business', 'Temple', 'IXM Airport'], origin: 'coimbatore', dest: 'madurai', dist: 210, time: 4.25, hw: ['NH83'], toll: '₹160 - ₹220', tollCount: 2 },
  { slug: 'madurai-to-tirunelveli', from: 'Madurai', to: 'Tirunelveli', category: 'City', popularity: 9, isFeatured: false, purposes: ['Business', 'Halwa City', 'Family'], origin: 'madurai', dest: 'tirunelveli', dist: 160, time: 2.75, hw: ['NH44'], toll: '₹180 - ₹230', tollCount: 2 },
  { slug: 'tirunelveli-to-madurai', from: 'Tirunelveli', to: 'Madurai', category: 'City', popularity: 9, isFeatured: false, purposes: ['IXM Airport', 'Medical', 'Temple'], origin: 'tirunelveli', dest: 'madurai', dist: 160, time: 2.75, hw: ['NH44'], toll: '₹180 - ₹230', tollCount: 2 },

  { slug: 'coimbatore-to-salem', from: 'Coimbatore', to: 'Salem', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Textile', 'Steel'], origin: 'coimbatore', dest: 'salem', dist: 165, time: 3.0, hw: ['NH544'], toll: '₹180 - ₹240', tollCount: 2 },
  { slug: 'salem-to-coimbatore', from: 'Salem', to: 'Coimbatore', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'CJB Airport', 'Medical'], origin: 'salem', dest: 'coimbatore', dist: 165, time: 3.0, hw: ['NH544'], toll: '₹180 - ₹240', tollCount: 2 },
  { slug: 'coimbatore-to-erode', from: 'Coimbatore', to: 'Erode', category: 'City', popularity: 8, isFeatured: false, purposes: ['Textile', 'Business'], origin: 'coimbatore', dest: 'erode', dist: 100, time: 2.0, hw: ['NH544'], toll: '₹90 - ₹130', tollCount: 1 },
  { slug: 'erode-to-coimbatore', from: 'Erode', to: 'Coimbatore', category: 'City', popularity: 8, isFeatured: false, purposes: ['CJB Airport', 'Medical', 'Corporate'], origin: 'erode', dest: 'coimbatore', dist: 100, time: 2.0, hw: ['NH544'], toll: '₹90 - ₹130', tollCount: 1 },
  { slug: 'coimbatore-to-pollachi', from: 'Coimbatore', to: 'Pollachi', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Agriculture', 'Film Location'], origin: 'coimbatore', dest: 'coimbatore', dist: 45, time: 1.0, hw: ['NH83'], toll: '₹40 - ₹60', tollCount: 1 },
  { slug: 'pollachi-to-coimbatore', from: 'Pollachi', to: 'Coimbatore', category: 'City', popularity: 8, isFeatured: false, purposes: ['CJB Airport', 'Medical', 'Education'], origin: 'coimbatore', dest: 'coimbatore', dist: 45, time: 1.0, hw: ['NH83'], toll: '₹40 - ₹60', tollCount: 1 },
  { slug: 'salem-to-erode', from: 'Salem', to: 'Erode', category: 'City', popularity: 8, isFeatured: false, purposes: ['Textile', 'Business'], origin: 'salem', dest: 'erode', dist: 65, time: 1.25, hw: ['NH544'], toll: '₹50 - ₹80', tollCount: 1 },
  { slug: 'erode-to-salem', from: 'Erode', to: 'Salem', category: 'City', popularity: 8, isFeatured: false, purposes: ['Business', 'Transit'], origin: 'erode', dest: 'salem', dist: 65, time: 1.25, hw: ['NH544'], toll: '₹50 - ₹80', tollCount: 1 },

  // ── TEMPLE / PILGRIMAGE ROUTES (`Temple`) ──
  { slug: 'trichy-to-velankanni', from: 'Trichy', to: 'Velankanni', category: 'Temple', popularity: 10, isFeatured: true, purposes: ['Pilgrimage', 'Basilica', 'Tourism'], origin: 'tiruchirappalli', dest: 'nagapattinam', dist: 155, time: 3.5, hw: ['NH83', 'SH22'], toll: '₹90 - ₹140', tollCount: 1 },
  { slug: 'velankanni-to-trichy', from: 'Velankanni', to: 'Trichy', category: 'Temple', popularity: 10, isFeatured: false, purposes: ['TRZ Airport', 'Pilgrimage Return'], origin: 'nagapattinam', dest: 'tiruchirappalli', dist: 155, time: 3.5, hw: ['SH22', 'NH83'], toll: '₹90 - ₹140', tollCount: 1 },
  { slug: 'trichy-to-kumbakonam', from: 'Trichy', to: 'Kumbakonam', category: 'Temple', popularity: 9, isFeatured: true, purposes: ['Navagraha Pilgrimage', 'Temples'], origin: 'tiruchirappalli', dest: 'thanjavur', dist: 90, time: 2.0, hw: ['NH36'], toll: '₹60 - ₹90', tollCount: 1 },
  { slug: 'kumbakonam-to-trichy', from: 'Kumbakonam', to: 'Trichy', category: 'Temple', popularity: 9, isFeatured: false, purposes: ['TRZ Airport', 'Pilgrimage Return'], origin: 'thanjavur', dest: 'tiruchirappalli', dist: 90, time: 2.0, hw: ['NH36'], toll: '₹60 - ₹90', tollCount: 1 },
  { slug: 'trichy-to-chidambaram', from: 'Trichy', to: 'Chidambaram', category: 'Temple', popularity: 8, isFeatured: false, purposes: ['Nataraja Temple', 'Pilgrimage', 'Annamalai Univ'], origin: 'tiruchirappalli', dest: 'cuddalore', dist: 170, time: 3.75, hw: ['NH36'], toll: '₹120 - ₹170', tollCount: 2 },
  { slug: 'chidambaram-to-trichy', from: 'Chidambaram', to: 'Trichy', category: 'Temple', popularity: 8, isFeatured: false, purposes: ['TRZ Airport', 'Pilgrimage Return'], origin: 'cuddalore', dest: 'tiruchirappalli', dist: 170, time: 3.75, hw: ['NH36'], toll: '₹120 - ₹170', tollCount: 2 },

  { slug: 'madurai-to-rameswaram', from: 'Madurai', to: 'Rameshwaram', category: 'Temple', popularity: 10, isFeatured: true, purposes: ['Pilgrimage', 'Dhanushkodi', 'Pamban Bridge'], origin: 'madurai', dest: 'ramanathapuram', dist: 175, time: 3.5, hw: ['NH87', 'Pamban Sea Bridge'], toll: '₹120 - ₹180', tollCount: 2 },
  { slug: 'rameswaram-to-madurai', from: 'Rameshwaram', to: 'Madurai', category: 'Temple', popularity: 10, isFeatured: false, purposes: ['IXM Airport', 'Pilgrimage Return'], origin: 'ramanathapuram', dest: 'madurai', dist: 175, time: 3.5, hw: ['NH87'], toll: '₹120 - ₹180', tollCount: 2 },
  { slug: 'madurai-to-tiruchendur', from: 'Madurai', to: 'Tiruchendur', category: 'Temple', popularity: 9, isFeatured: true, purposes: ['Subramanya Swamy Temple', 'Pilgrimage'], origin: 'madurai', dest: 'thoothukudi', dist: 180, time: 3.5, hw: ['NH38'], toll: '₹140 - ₹190', tollCount: 2 },
  { slug: 'tiruchendur-to-madurai', from: 'Tiruchendur', to: 'Madurai', category: 'Temple', popularity: 9, isFeatured: false, purposes: ['IXM Airport', 'Pilgrimage Return'], origin: 'thoothukudi', dest: 'madurai', dist: 180, time: 3.5, hw: ['NH38'], toll: '₹140 - ₹190', tollCount: 2 },

  { slug: 'chennai-to-kanchipuram', from: 'Chennai', to: 'Kanchipuram', category: 'Temple', popularity: 9, isFeatured: true, purposes: ['Silk Sarees', 'Pilgrimage', 'Heritage'], origin: 'chennai', dest: 'kanchipuram', dist: 75, time: 1.75, hw: ['NH48'], toll: '₹70 - ₹100', tollCount: 1 },
  { slug: 'kanchipuram-to-chennai', from: 'Kanchipuram', to: 'Chennai', category: 'Temple', popularity: 9, isFeatured: false, purposes: ['MAA Airport', 'Shopping Return'], origin: 'kanchipuram', dest: 'chennai', dist: 75, time: 1.75, hw: ['NH48'], toll: '₹70 - ₹100', tollCount: 1 },
  { slug: 'chennai-to-chidambaram', from: 'Chennai', to: 'Chidambaram', category: 'Temple', popularity: 8, isFeatured: false, purposes: ['Pilgrimage', 'Temple', 'University'], origin: 'chennai', dest: 'cuddalore', dist: 230, time: 4.5, hw: ['ECR', 'NH32'], toll: '₹220 - ₹290', tollCount: 3 },
  { slug: 'chidambaram-to-chennai', from: 'Chidambaram', to: 'Chennai', category: 'Temple', popularity: 8, isFeatured: false, purposes: ['MAA Airport', 'Medical'], origin: 'cuddalore', dest: 'chennai', dist: 230, time: 4.5, hw: ['NH32', 'ECR'], toll: '₹220 - ₹290', tollCount: 3 },

  // ── TOURIST ROUTES (`Tourist`) ──
  { slug: 'coimbatore-to-ooty', from: 'Coimbatore', to: 'Ooty', category: 'Tourist', popularity: 10, isFeatured: true, purposes: ['Tourism', 'Resort', 'Honeymoon'], origin: 'coimbatore', dest: 'nilgiris', dist: 85, time: 2.75, hw: ['NH181', 'Hairpin Bends Route'], toll: '₹60 - ₹100', tollCount: 1 },
  { slug: 'ooty-to-coimbatore', from: 'Ooty', to: 'Coimbatore', category: 'Tourist', popularity: 10, isFeatured: false, purposes: ['CJB Airport', 'Railway Return'], origin: 'nilgiris', dest: 'coimbatore', dist: 85, time: 2.75, hw: ['NH181', 'Mettupalayam Road'], toll: '₹60 - ₹100', tollCount: 1 },
  { slug: 'coimbatore-to-coonoor', from: 'Coimbatore', to: 'Coonoor', category: 'Tourist', popularity: 9, isFeatured: false, purposes: ['Tea Gardens', 'Sims Park', 'Tourism'], origin: 'coimbatore', dest: 'nilgiris', dist: 70, time: 2.25, hw: ['NH181'], toll: '₹60 - ₹90', tollCount: 1 },
  { slug: 'coonoor-to-coimbatore', from: 'Coonoor', to: 'Coimbatore', category: 'Tourist', popularity: 9, isFeatured: false, purposes: ['CJB Airport', 'Tourism Return'], origin: 'nilgiris', dest: 'coimbatore', dist: 70, time: 2.25, hw: ['NH181'], toll: '₹60 - ₹90', tollCount: 1 },
  { slug: 'coimbatore-to-valparai', from: 'Coimbatore', to: 'Valparai', category: 'Tourist', popularity: 8, isFeatured: false, purposes: ['Tea Plantations', 'Wildlife', 'Hairpin Bends'], origin: 'coimbatore', dest: 'coimbatore', dist: 105, time: 3.5, hw: ['SH78 Ghat Road'], toll: '₹50 - ₹80', tollCount: 1 },
  { slug: 'valparai-to-coimbatore', from: 'Valparai', to: 'Coimbatore', category: 'Tourist', popularity: 8, isFeatured: false, purposes: ['CJB Airport', 'Tourism Return'], origin: 'coimbatore', dest: 'coimbatore', dist: 105, time: 3.5, hw: ['SH78 Ghat Road'], toll: '₹50 - ₹80', tollCount: 1 },
  { slug: 'coimbatore-to-munnar', from: 'Coimbatore', to: 'Munnar', category: 'Tourist', popularity: 9, isFeatured: true, purposes: ['Tourism', 'Tea Hills', 'Resort Stay'], origin: 'coimbatore', dest: 'coimbatore', dist: 160, time: 4.5, hw: ['SH17', 'Udumalpet Ghat Road'], toll: '₹90 - ₹140', tollCount: 1 },
  { slug: 'munnar-to-coimbatore', from: 'Munnar', to: 'Coimbatore', category: 'Tourist', popularity: 9, isFeatured: false, purposes: ['CJB Airport', 'Tourism Return'], origin: 'coimbatore', dest: 'coimbatore', dist: 160, time: 4.5, hw: ['Udumalpet Ghat Road', 'SH17'], toll: '₹90 - ₹140', tollCount: 1 },
  ...
  { slug: 'tirupati-to-vellore', from: 'Tirupati', to: 'Vellore', category: 'Interstate', popularity: 9, isFeatured: false, purposes: ['CMC Hospital Transfer'], origin: 'vellore', dest: 'vellore', dist: 110, time: 2.5, hw: ['NH716'], toll: '₹110 - ₹150', tollCount: 2 },
  { slug: 'coimbatore-to-palakkad', from: 'Coimbatore', to: 'Palakkad', category: 'Interstate', popularity: 8, isFeatured: false, purposes: ['Border Commute', 'Business'], origin: 'coimbatore', dest: 'coimbatore', dist: 55, time: 1.25, hw: ['NH544'], toll: '₹60 - ₹90', tollCount: 1 },
  { slug: 'palakkad-to-coimbatore', from: 'Palakkad', to: 'Coimbatore', category: 'Interstate', popularity: 8, isFeatured: false, purposes: ['CJB Airport', 'Medical'], origin: 'coimbatore', dest: 'coimbatore', dist: 55, time: 1.25, hw: ['NH544'], toll: '₹60 - ₹90', tollCount: 1 },
  { slug: 'kanyakumari-to-trivandrum', from: 'Kanyakumari', to: 'Trivandrum', category: 'Interstate', popularity: 8, isFeatured: false, purposes: ['TRV Airport', 'Kerala Transit'], origin: 'kanyakumari', dest: 'kanyakumari', dist: 90, time: 2.25, hw: ['NH66'], toll: '₹80 - ₹120', tollCount: 1 },
  { slug: 'trivandrum-to-kanyakumari', from: 'Trivandrum', to: 'Kanyakumari', category: 'Interstate', popularity: 8, isFeatured: false, purposes: ['Sunset View', 'Vivekananda Rock'], origin: 'kanyakumari', dest: 'kanyakumari', dist: 90, time: 2.25, hw: ['NH66'], toll: '₹80 - ₹120', tollCount: 1 },
];
...
phase1Routes.forEach((r) => {
  ...
  contentJs += `    isFeatured: ${r.isFeatured},\n`;
  contentJs += `    seasonality: ${JSON.stringify(meta.seasonality)},\n`;
