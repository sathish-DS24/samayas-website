...
export interface PopularTransfer {
  ...
  travelTime: string;
  startingFare: number;
  type: 'City' | 'Tourist' | 'District' | 'Pilgrimage';
}
...
export interface AirportItem {
  ...
  nearbyRailwayStations: NearbyPlace[];
  nearbyBusStand: NearbyPlace[];
  popularRoutes: PopularTransfer[];
  faq: AirportFaq[];
  seo: {
    title: string;
    description: string;
...
export const airportsMasterDataset: AirportItem[] = [
  // ── TAMIL NADU AIRPORTS ──
  {
    id: 'maa',
...
export function getAirportsByType(type?: 'All' | 'International' | 'Domestic'): AirportItem[] {
