...
Whether commuting for business at BHEL, attending university at NIT-Trichy, or visiting sacred sites like Srirangam, SAMAYAS provides seamless 24/7 one-way taxi connections.`,
    ...
    routes: [
      { name: 'Trichy to Chennai', to: 'Chennai', distanceKm: 330, timeHours: 5.5, startingFare: 3800 },
      { name: 'Trichy to Madurai', to: 'Madurai', distanceKm: 135, timeHours: 2.5, startingFare: 1800 },
      { name: 'Trichy to Coimbatore', to: 'Coimbatore', distanceKm: 215, timeHours: 4, startingFare: 2600 },
      { name: 'Trichy to Thanjavur', to: 'Thanjavur', distanceKm: 57, timeHours: 1.25, startingFare: 900 },
      { name: 'Trichy to Bengaluru', to: 'Bengaluru', distanceKm: 345, timeHours: 6, startingFare: 4200 },
      { name: 'Trichy to Pondicherry', to: 'Pondicherry', distanceKm: 210, timeHours: 4, startingFare: 2900 },
      { name: 'Trichy to Salem', to: 'Salem', distanceKm: 140, timeHours: 2.5, startingFare: 1900 },
      { name: 'Trichy to Kumbakonam', to: 'Kumbakonam', distanceKm: 95, timeHours: 2, startingFare: 1500 },
      { name: 'Trichy to Dindigul', to: 'Dindigul', distanceKm: 95, timeHours: 2, startingFare: 1500 },
    ],

    // § 6 — Fare table (top 6 routes with per-vehicle-type pricing)
    fareTable: [
      { to: 'Chennai',     distanceKm: 330, timeHours: 5.5,  hatchback: 3800, sedan: 4300, suv: 5800 },
      { to: 'Madurai',     distanceKm: 135, timeHours: 2.5,  hatchback: 1800, sedan: 2100, suv: 2800 },
      { to: 'Coimbatore',  distanceKm: 215, timeHours: 4,    hatchback: 2600, sedan: 3000, suv: 4100 },
      { to: 'Thanjavur',   distanceKm: 57,  timeHours: 1.25, hatchback: 900,  sedan: 1100, suv: 1500 },
      { to: 'Bengaluru',   distanceKm: 345, timeHours: 6,    hatchback: 4200, sedan: 4800, suv: 6500 },
      { to: 'Salem',       distanceKm: 140, timeHours: 2.5,  hatchback: 1900, sedan: 2200, suv: 2900 },
    ],
...
Transport in Ariyalur is anchored by the Ariyalur Railway Junction on the main Chennai–Trichy chord line and state highways SH-139 and SH-27. Whether you are an industrial executive visiting limestone plants, a scholar exploring Cretaceous fossil beds, or a family traveling for heritage tourism, SAMAYAS offers reliable 24/7 one-way taxi transfers from Ariyalur with transparent per-kilometer pricing and zero return fare penalties.`,
    ...
    routes: [
      { name: 'Ariyalur to Chennai', to: 'Chennai', distanceKm: 265, timeHours: 4.75, startingFare: 3200 },
      { name: 'Ariyalur to Trichy', to: 'Trichy', distanceKm: 60, timeHours: 1.25, startingFare: 1000 },
      { name: 'Ariyalur to Thanjavur', to: 'Thanjavur', distanceKm: 65, timeHours: 1.3, startingFare: 1100 },
      { name: 'Ariyalur to Jayankondam', to: 'Jayankondam', distanceKm: 32, timeHours: 0.6, startingFare: 600 },
      { name: 'Ariyalur to Chidambaram', to: 'Chidambaram', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Ariyalur to Kumbakonam', to: 'Kumbakonam', distanceKm: 55, timeHours: 1.2, startingFare: 950 },
      { name: 'Ariyalur to Perambalur', to: 'Perambalur', distanceKm: 30, timeHours: 0.5, startingFare: 600 },
      { name: 'Ariyalur to Pondicherry', to: 'Pondicherry', distanceKm: 135, timeHours: 2.75, startingFare: 2100 },
      { name: 'Ariyalur to Madurai', to: 'Madurai', distanceKm: 195, timeHours: 3.5, startingFare: 2700 },
    ],

    fareTable: [
      { to: 'Chennai',     distanceKm: 265, timeHours: 4.75, hatchback: 3200, sedan: 3600, suv: 4900 },
      { to: 'Trichy',      distanceKm: 60,  timeHours: 1.25, hatchback: 1000, sedan: 1200, suv: 1600 },
      { to: 'Thanjavur',   distanceKm: 65,  timeHours: 1.3,  hatchback: 1100, sedan: 1300, suv: 1700 },
      { to: 'Chidambaram', distanceKm: 85,  timeHours: 1.75, hatchback: 1400, sedan: 1600, suv: 2200 },
      { to: 'Kumbakonam',  distanceKm: 55,  timeHours: 1.2,  hatchback: 950,  sedan: 1150, suv: 1500 },
      { to: 'Pondicherry', distanceKm: 135, timeHours: 2.75, hatchback: 2100, sedan: 2400, suv: 3200 },
    ],
...
Transportation infrastructure in Chengalpattu is exceptionally well-connected, centered around Chengalpattu Railway Junction—a major multi-railway line interchange—and direct proximity to Chennai International Airport (MAA) just 40 km north. Whether you are an IT executive commuting from Mahindra World City, a medical tourist visiting SRM Medical Complex, or a vacationer traveling along the East Coast Road (ECR), SAMAYAS provides premium, reliable 24/7 one-way cabs from Chengalpattu with zero return charges.`,
    ...
    routes: [
      { name: 'Chengalpattu to Chennai Airport', to: 'Chennai Airport', distanceKm: 40, timeHours: 0.75, startingFare: 800 },
      { name: 'Chengalpattu to Puducherry', to: 'Puducherry', distanceKm: 110, timeHours: 2.25, startingFare: 1700 },
      { name: 'Chengalpattu to Mahabalipuram', to: 'Mahabalipuram', distanceKm: 30, timeHours: 0.5, startingFare: 600 },
      { name: 'Chengalpattu to Trichy', to: 'Trichy', distanceKm: 290, timeHours: 4.75, startingFare: 3400 },
      { name: 'Chengalpattu to Bengaluru', to: 'Bengaluru', distanceKm: 320, timeHours: 5.5, startingFare: 3900 },
      { name: 'Chengalpattu to Vellore', to: 'Vellore', distanceKm: 115, timeHours: 2.2, startingFare: 1800 },
      { name: 'Chengalpattu to Kanchipuram', to: 'Kanchipuram', distanceKm: 35, timeHours: 0.75, startingFare: 700 },
      { name: 'Chengalpattu to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 145, timeHours: 3, startingFare: 2200 },
      { name: 'Chengalpattu to Madurai', to: 'Madurai', distanceKm: 420, timeHours: 6.5, startingFare: 4900 },
    ],

    fareTable: [
      { to: 'Chennai Airport', distanceKm: 40,  timeHours: 0.75, hatchback: 800,  sedan: 1000, suv: 1400 },
      { to: 'Puducherry',      distanceKm: 110, timeHours: 2.25, hatchback: 1700, sedan: 2000, suv: 2700 },
      { to: 'Mahabalipuram',   distanceKm: 30,  timeHours: 0.5,  hatchback: 600,  sedan: 750,  suv: 1100 },
      { to: 'Trichy',          distanceKm: 290, timeHours: 4.75, hatchback: 3400, sedan: 3900, suv: 5300 },
      { to: 'Bengaluru',       distanceKm: 320, timeHours: 5.5,  hatchback: 3900, sedan: 4500, suv: 6100 },
      { to: 'Tiruvannamalai',  distanceKm: 145, timeHours: 3,    hatchback: 2200, sedan: 2500, suv: 3400 },
    ],
...
As the central transit hub of South India, Chennai is anchored by Chennai International Airport (MAA), Dr. MGR Chennai Central Railway Station (MAS), Chennai Egmore (MS), and Asia's largest bus terminus at Koyambedu (CMBT) as well as Kilambakkam (KCBT). Whether you are arriving at Chennai Central for an outstation pilgrimage, commuting from OMR IT parks, or traveling for medical care, SAMAYAS provides transparent, round-the-clock one-way cabs from Chennai to all 38 districts with zero return charges.`,
    ...
    routes: [
      { name: 'Chennai to Puducherry', to: 'Puducherry', distanceKm: 150, timeHours: 3, startingFare: 2200 },
      { name: 'Chennai to Trichy', to: 'Trichy', distanceKm: 330, timeHours: 5.5, startingFare: 3800 },
      { name: 'Chennai to Bengaluru', to: 'Bengaluru', distanceKm: 345, timeHours: 6, startingFare: 4200 },
      { name: 'Chennai to Tirupati', to: 'Tirupati', distanceKm: 135, timeHours: 3.25, startingFare: 2400 },
      { name: 'Chennai to Vellore', to: 'Vellore', distanceKm: 140, timeHours: 2.75, startingFare: 2100 },
      { name: 'Chennai to Madurai', to: 'Madurai', distanceKm: 460, timeHours: 7.5, startingFare: 5400 },
      { name: 'Chennai to Coimbatore', to: 'Coimbatore', distanceKm: 500, timeHours: 8.5, startingFare: 5900 },
      { name: 'Chennai to Salem', to: 'Salem', distanceKm: 340, timeHours: 5.75, startingFare: 4100 },
      { name: 'Chennai to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 195, timeHours: 3.75, startingFare: 2800 },
    ],

    fareTable: [
      { to: 'Puducherry',     distanceKm: 150, timeHours: 3,    hatchback: 2200, sedan: 2500, suv: 3400 },
      { to: 'Trichy',         distanceKm: 330, timeHours: 5.5,  hatchback: 3800, sedan: 4300, suv: 5800 },
      { to: 'Bengaluru',      distanceKm: 345, timeHours: 6,    hatchback: 4200, sedan: 4800, suv: 6500 },
      { to: 'Tirupati',       distanceKm: 135, timeHours: 3.25, hatchback: 2400, sedan: 2800, suv: 3800 },
      { to: 'Vellore',        distanceKm: 140, timeHours: 2.75, hatchback: 2100, sedan: 2400, suv: 3300 },
      { to: 'Tiruvannamalai', distanceKm: 195, timeHours: 3.75, hatchback: 2800, sedan: 3200, suv: 4400 },
    ],
...
Coimbatore's transport network is anchored by Coimbatore International Airport (CJB) at Peelamedu, Coimbatore Junction Railway Station (CBE), and major intercity bus terminals at Gandhipuram, Singanallur, and Ukkadam. Serving as the primary gateway to Nilgiris hill stations like Ooty, Coonoor, and Valparai, SAMAYAS provides reliable 24/7 one-way taxi transfers from Coimbatore across Tamil Nadu and neighbouring states with zero return fare penalties.`,
    ...
    routes: [
      { name: 'Coimbatore to Ooty', to: 'Ooty', distanceKm: 85, timeHours: 3, startingFare: 2200 },
      { name: 'Coimbatore to Chennai', to: 'Chennai', distanceKm: 500, timeHours: 8.5, startingFare: 5900 },
      { name: 'Coimbatore to Trichy', to: 'Trichy', distanceKm: 215, timeHours: 4, startingFare: 2600 },
      { name: 'Coimbatore to Madurai', to: 'Madurai', distanceKm: 210, timeHours: 4, startingFare: 2500 },
      { name: 'Coimbatore to Bengaluru', to: 'Bengaluru', distanceKm: 365, timeHours: 6.5, startingFare: 4500 },
      { name: 'Coimbatore to Salem', to: 'Salem', distanceKm: 165, timeHours: 3, startingFare: 2100 },
      { name: 'Coimbatore to Erode', to: 'Erode', distanceKm: 100, timeHours: 2, startingFare: 1400 },
      { name: 'Coimbatore to Tiruppur', to: 'Tiruppur', distanceKm: 55, timeHours: 1.1, startingFare: 900 },
      { name: 'Coimbatore to Palakkad', to: 'Palakkad', distanceKm: 50, timeHours: 1.25, startingFare: 850 },
    ],

    fareTable: [
      { to: 'Ooty',       distanceKm: 85,  timeHours: 3,    hatchback: 2200, sedan: 2600, suv: 3600 },
      { to: 'Chennai',    distanceKm: 500, timeHours: 8.5,  hatchback: 5900, sedan: 6600, suv: 8900 },
      { to: 'Trichy',     distanceKm: 215, timeHours: 4,    hatchback: 2600, sedan: 3000, suv: 4100 },
      { to: 'Madurai',    distanceKm: 210, timeHours: 4,    hatchback: 2500, sedan: 2900, suv: 4000 },
      { to: 'Bengaluru',  distanceKm: 365, timeHours: 6.5,  hatchback: 4500, sedan: 5100, suv: 6900 },
      { to: 'Salem',      distanceKm: 165, timeHours: 3,    hatchback: 2100, sedan: 2400, suv: 3300 },
    ],
...
Transportation across Cuddalore is served by Cuddalore Port Junction (CUPJ), Thirupadripulyur (TDPR), and Chidambaram (CDM) railway stations, along with Cuddalore Central Bus Stand on ECR/NH-45A. Whether you are a power plant engineer traveling to Neyveli, a pilgrim visiting Chidambaram, or a traveler taking the coastal ECR route to Chennai or Puducherry, SAMAYAS provides reliable 24/7 one-way taxi services from Cuddalore with zero return fare charges.`,
    ...
    routes: [
      { name: 'Cuddalore to Chennai', to: 'Chennai', distanceKm: 180, timeHours: 3.75, startingFare: 2500 },
      { name: 'Cuddalore to Puducherry', to: 'Puducherry', distanceKm: 22, timeHours: 0.5, startingFare: 500 },
      { name: 'Cuddalore to Chidambaram', to: 'Chidambaram', distanceKm: 45, timeHours: 1, startingFare: 850 },
      { name: 'Cuddalore to Neyveli', to: 'Neyveli', distanceKm: 32, timeHours: 0.7, startingFare: 650 },
      { name: 'Cuddalore to Trichy', to: 'Trichy', distanceKm: 185, timeHours: 3.5, startingFare: 2600 },
      { name: 'Cuddalore to Kumbakonam', to: 'Kumbakonam', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Cuddalore to Salem', to: 'Salem', distanceKm: 210, timeHours: 4, startingFare: 2900 },
      { name: 'Cuddalore to Villupuram', to: 'Villupuram', distanceKm: 45, timeHours: 1, startingFare: 800 },
      { name: 'Cuddalore to Thanjavur', to: 'Thanjavur', distanceKm: 120, timeHours: 2.5, startingFare: 1900 },
    ],

    fareTable: [
      { to: 'Chennai',     distanceKm: 180, timeHours: 3.75, hatchback: 2500, sedan: 2900, suv: 3900 },
      { to: 'Puducherry',  distanceKm: 22,  timeHours: 0.5,  hatchback: 500,  sedan: 650,  suv: 950 },
      { to: 'Chidambaram', distanceKm: 45,  timeHours: 1,    hatchback: 850,  sedan: 1000, suv: 1400 },
      { to: 'Neyveli',     distanceKm: 32,  timeHours: 0.7,  hatchback: 650,  sedan: 800,  suv: 1100 },
      { to: 'Trichy',      distanceKm: 185, timeHours: 3.5,  hatchback: 2600, sedan: 3000, suv: 4100 },
      { to: 'Kumbakonam',  distanceKm: 85,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2300 },
    ],
...
Strategically traversed by National Highway NH-44 (North-South Corridor), Dharmapuri offers rapid road connectivity between Bengaluru, Hosur, Salem, and Coimbatore. SAMAYAS delivers round-the-clock 24/7 one-way cabs from Dharmapuri, Pennagaram, Harur, and Palacode to all destinations across Tamil Nadu and Karnataka with zero return fare charges.`,
    ...
    routes: [
      { name: 'Dharmapuri to Hogenakkal', to: 'Hogenakkal', distanceKm: 46, timeHours: 1.1, startingFare: 850 },
      { name: 'Dharmapuri to Bengaluru', to: 'Bengaluru', distanceKm: 140, timeHours: 2.75, startingFare: 2100 },
      { name: 'Dharmapuri to Salem', to: 'Salem', distanceKm: 68, timeHours: 1.25, startingFare: 1100 },
      { name: 'Dharmapuri to Hosur', to: 'Hosur', distanceKm: 90, timeHours: 1.75, startingFare: 1450 },
      { name: 'Dharmapuri to Chennai', to: 'Chennai', distanceKm: 290, timeHours: 5.25, startingFare: 3600 },
      { name: 'Dharmapuri to Coimbatore', to: 'Coimbatore', distanceKm: 230, timeHours: 4.25, startingFare: 2900 },
      { name: 'Dharmapuri to Trichy', to: 'Trichy', distanceKm: 210, timeHours: 3.75, startingFare: 2700 },
      { name: 'Dharmapuri to Krishnagiri', to: 'Krishnagiri', distanceKm: 45, timeHours: 0.8, startingFare: 750 },
      { name: 'Dharmapuri to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 115, timeHours: 2.5, startingFare: 1800 },
    ],

    fareTable: [
      { to: 'Hogenakkal', distanceKm: 46,  timeHours: 1.1,  hatchback: 850,  sedan: 1050, suv: 1450 },
      { to: 'Bengaluru',  distanceKm: 140, timeHours: 2.75, hatchback: 2100, sedan: 2450, suv: 3400 },
      { to: 'Salem',      distanceKm: 68,  timeHours: 1.25, hatchback: 1100, sedan: 1300, suv: 1800 },
      { to: 'Hosur',      distanceKm: 90,  timeHours: 1.75, hatchback: 1450, sedan: 1700, suv: 2350 },
      { to: 'Chennai',    distanceKm: 290, timeHours: 5.25, hatchback: 3600, sedan: 4100, suv: 5600 },
      { to: 'Coimbatore', distanceKm: 230, timeHours: 4.25, hatchback: 2900, sedan: 3300, suv: 4500 },
    ],
...
Transportation in Dindigul is anchored by Dindigul Railway Junction (DG), Kodaikanal Road Station (KQN), and Dindigul Central Bus Stand, connected seamlessly via NH-44 and NH-83. Whether you are traveling uphill to Kodaikanal, visiting Palani Murugan Temple, or commuting for business in leather tanneries and lock manufacturing units, SAMAYAS offers reliable 24/7 one-way cabs from Dindigul with zero return fare charges.`,
    ...
    routes: [
      { name: 'Dindigul to Kodaikanal', to: 'Kodaikanal', distanceKm: 95, timeHours: 3, startingFare: 2400 },
      { name: 'Dindigul to Palani', to: 'Palani', distanceKm: 60, timeHours: 1.2, startingFare: 1100 },
      { name: 'Dindigul to Madurai', to: 'Madurai', distanceKm: 65, timeHours: 1.25, startingFare: 1200 },
      { name: 'Dindigul to Trichy', to: 'Trichy', distanceKm: 95, timeHours: 1.75, startingFare: 1500 },
      { name: 'Dindigul to Chennai', to: 'Chennai', distanceKm: 420, timeHours: 7, startingFare: 4900 },
      { name: 'Dindigul to Coimbatore', to: 'Coimbatore', distanceKm: 155, timeHours: 3.25, startingFare: 2200 },
      { name: 'Dindigul to Salem', to: 'Salem', distanceKm: 170, timeHours: 3.25, startingFare: 2300 },
      { name: 'Dindigul to Karur', to: 'Karur', distanceKm: 75, timeHours: 1.5, startingFare: 1300 },
      { name: 'Dindigul to Theni', to: 'Theni', distanceKm: 75, timeHours: 1.5, startingFare: 1300 },
    ],

    fareTable: [
      { to: 'Kodaikanal', distanceKm: 95,  timeHours: 3,    hatchback: 2400, sedan: 2800, suv: 3800 },
      { to: 'Palani',     distanceKm: 60,  timeHours: 1.2,  hatchback: 1100, sedan: 1300, suv: 1800 },
      { to: 'Madurai',    distanceKm: 65,  timeHours: 1.25, hatchback: 1200, sedan: 1450, suv: 2000 },
      { to: 'Trichy',     distanceKm: 95,  timeHours: 1.75, hatchback: 1500, sedan: 1750, suv: 2400 },
      { to: 'Chennai',    distanceKm: 420, timeHours: 7,    hatchback: 4900, sedan: 5500, suv: 7400 },
      { to: 'Coimbatore', distanceKm: 155, timeHours: 3.25, hatchback: 2200, sedan: 2500, suv: 3500 },
    ],
...
Transportation in Erode is anchored by Erode Junction (ED)—a major A1-category railway junction on the Salem-Coimbatore trunk line—and Erode Central Bus Stand. Whether you are a textile buyer visiting Texvalley, a merchant attending turmeric auctions, or a traveler taking an outstation trip to Ooty, Coimbatore, or Bengaluru, SAMAYAS provides reliable 24/7 one-way cabs from Erode with zero return fare charges.`,
    ...
    routes: [
      { name: 'Erode to Coimbatore', to: 'Coimbatore', distanceKm: 100, timeHours: 2, startingFare: 1400 },
      { name: 'Erode to Salem', to: 'Salem', distanceKm: 65, timeHours: 1.25, startingFare: 1000 },
      { name: 'Erode to Tiruppur', to: 'Tiruppur', distanceKm: 50, timeHours: 1, startingFare: 800 },
      { name: 'Erode to Chennai', to: 'Chennai', distanceKm: 400, timeHours: 6.75, startingFare: 4600 },
      { name: 'Erode to Bengaluru', to: 'Bengaluru', distanceKm: 285, timeHours: 5.25, startingFare: 3600 },
      { name: 'Erode to Ooty', to: 'Ooty', distanceKm: 140, timeHours: 4, startingFare: 3200 },
      { name: 'Erode to Trichy', to: 'Trichy', distanceKm: 150, timeHours: 3, startingFare: 2200 },
      { name: 'Erode to Madurai', to: 'Madurai', distanceKm: 195, timeHours: 3.75, startingFare: 2600 },
      { name: 'Erode to Karur', to: 'Karur', distanceKm: 65, timeHours: 1.25, startingFare: 1000 },
    ],

    fareTable: [
      { to: 'Coimbatore', distanceKm: 100, timeHours: 2,    hatchback: 1400, sedan: 1650, suv: 2300 },
      { to: 'Salem',      distanceKm: 65,  timeHours: 1.25, hatchback: 1000, sedan: 1200, suv: 1700 },
      { to: 'Tiruppur',   distanceKm: 50,  timeHours: 1,    hatchback: 800,  sedan: 950,  suv: 1350 },
      { to: 'Chennai',    distanceKm: 400, timeHours: 6.75, hatchback: 4600, sedan: 5200, suv: 7100 },
      { to: 'Bengaluru',  distanceKm: 285, timeHours: 5.25, hatchback: 3600, sedan: 4100, suv: 5600 },
      { to: 'Ooty',       distanceKm: 140, timeHours: 4,    hatchback: 3200, sedan: 3700, suv: 5100 },
    ],
...
Kallakurichi occupies an indispensable transport position anchored by Ulundurpet—where National Highways NH-45 (Chennai-Trichy) and NH-79 (Salem-Chennai expressway) meet—as well as Chinnasalem Railway Station (CS). Whether you are a sugar industry professional, an agricultural merchant, or a traveler exploring Kalvarayan Hills, SAMAYAS provides reliable 24/7 one-way cabs from Kallakurichi with zero return fare charges.`,
    ...
    routes: [
      { name: 'Kallakurichi to Chennai', to: 'Chennai', distanceKm: 240, timeHours: 4.25, startingFare: 3000 },
      { name: 'Kallakurichi to Salem', to: 'Salem', distanceKm: 75, timeHours: 1.3, startingFare: 1150 },
      { name: 'Kallakurichi to Trichy', to: 'Trichy', distanceKm: 135, timeHours: 2.5, startingFare: 2000 },
      { name: 'Kallakurichi to Puducherry', to: 'Puducherry', distanceKm: 110, timeHours: 2.25, startingFare: 1700 },
      { name: 'Kallakurichi to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 60, timeHours: 1.2, startingFare: 1000 },
      { name: 'Kallakurichi to Cuddalore', to: 'Cuddalore', distanceKm: 100, timeHours: 2, startingFare: 1500 },
      { name: 'Kallakurichi to Kalvarayan Hills', to: 'Kalvarayan Hills', distanceKm: 45, timeHours: 1.25, startingFare: 900 },
      { name: 'Kallakurichi to Villupuram', to: 'Villupuram', distanceKm: 70, timeHours: 1.25, startingFare: 1100 },
      { name: 'Kallakurichi to Bengaluru', to: 'Bengaluru', distanceKm: 230, timeHours: 4.5, startingFare: 3100 },
    ],

    fareTable: [
      { to: 'Chennai',        distanceKm: 240, timeHours: 4.25, hatchback: 3000, sedan: 3400, suv: 4600 },
      { to: 'Salem',          distanceKm: 75,  timeHours: 1.3,  hatchback: 1150, sedan: 1350, suv: 1850 },
      { to: 'Trichy',         distanceKm: 135, timeHours: 2.5,  hatchback: 2000, sedan: 2300, suv: 3100 },
      { to: 'Puducherry',     distanceKm: 110, timeHours: 2.25, hatchback: 1700, sedan: 2000, suv: 2700 },
      { to: 'Tiruvannamalai', distanceKm: 60,  timeHours: 1.2,  hatchback: 1000, sedan: 1200, suv: 1600 },
      { to: 'Kalvarayan Hills', distanceKm: 45, timeHours: 1.25, hatchback: 900,  sedan: 1100, suv: 1500 },
    ],
...
Transportation in Kanchipuram is anchored by Kanchipuram Railway Station (CKM), Kanchipuram Central Bus Stand, and Sriperumbudur Junction along the Chennai-Bengaluru expressway (NH-48), with Chennai International Airport (MAA) just 60 km away. Whether you are shopping for silk sarees, visiting ancient temples, commuting to Sriperumbudur SEZs, or catching a flight, SAMAYAS provides reliable 24/7 one-way cabs from Kanchipuram with zero return fare charges.`,
    ...
    routes: [
      { name: 'Kanchipuram to Chennai Airport', to: 'Chennai Airport', distanceKm: 60, timeHours: 1.2, startingFare: 1100 },
      { name: 'Kanchipuram to Chennai City', to: 'Chennai City', distanceKm: 70, timeHours: 1.5, startingFare: 1300 },
      { name: 'Kanchipuram to Bengaluru', to: 'Bengaluru', distanceKm: 275, timeHours: 5, startingFare: 3500 },
      { name: 'Kanchipuram to Vellore', to: 'Vellore', distanceKm: 70, timeHours: 1.3, startingFare: 1200 },
      { name: 'Kanchipuram to Puducherry', to: 'Puducherry', distanceKm: 115, timeHours: 2.3, startingFare: 1800 },
      { name: 'Kanchipuram to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 110, timeHours: 2.25, startingFare: 1750 },
      { name: 'Kanchipuram to Tirupati', to: 'Tirupati', distanceKm: 125, timeHours: 3, startingFare: 2200 },
      { name: 'Kanchipuram to Trichy', to: 'Trichy', distanceKm: 260, timeHours: 4.5, startingFare: 3200 },
      { name: 'Kanchipuram to Mahabalipuram', to: 'Mahabalipuram', distanceKm: 65, timeHours: 1.25, startingFare: 1100 },
    ],

    fareTable: [
      { to: 'Chennai Airport', distanceKm: 60,  timeHours: 1.2,  hatchback: 1100, sedan: 1300, suv: 1800 },
      { to: 'Chennai City',    distanceKm: 70,  timeHours: 1.5,  hatchback: 1300, sedan: 1500, suv: 2100 },
      { to: 'Bengaluru',       distanceKm: 275, timeHours: 5,    hatchback: 3500, sedan: 4000, suv: 5500 },
      { to: 'Vellore',         distanceKm: 70,  timeHours: 1.3,  hatchback: 1200, sedan: 1400, suv: 1900 },
      { to: 'Puducherry',      distanceKm: 115, timeHours: 2.3,  hatchback: 1800, sedan: 2100, suv: 2900 },
      { to: 'Tiruvannamalai',  distanceKm: 110, timeHours: 2.25, hatchback: 1750, sedan: 2000, suv: 2800 },
    ],
...
Transportation in Kanyakumari is anchored by Kanyakumari Railway Station (CAPE), Nagercoil Junction (NCJ), and Kanyakumari Central Bus Stand on NH-44, with Trivandrum International Airport (TRV) just 90 km away. Whether you are taking an oceanfront vacation, visiting Suchindram Temple, traveling to Trivandrum Airport, or embarking on an outstation trip along NH-44, SAMAYAS provides reliable 24/7 one-way cabs from Kanyakumari with zero return fare charges.`,
    ...
    routes: [
      { name: 'Kanyakumari to Trivandrum', to: 'Trivandrum', distanceKm: 85, timeHours: 2.25, startingFare: 1800 },
      { name: 'Kanyakumari to Madurai', to: 'Madurai', distanceKm: 245, timeHours: 4, startingFare: 3200 },
      { name: 'Kanyakumari to Tirunelveli', to: 'Tirunelveli', distanceKm: 85, timeHours: 1.5, startingFare: 1300 },
      { name: 'Kanyakumari to Rameshwaram', to: 'Rameshwaram', distanceKm: 310, timeHours: 5.5, startingFare: 4200 },
      { name: 'Kanyakumari to Chennai', to: 'Chennai', distanceKm: 700, timeHours: 11.5, startingFare: 8200 },
      { name: 'Kanyakumari to Coimbatore', to: 'Coimbatore', distanceKm: 430, timeHours: 7.5, startingFare: 5600 },
      { name: 'Kanyakumari to Kochi', to: 'Kochi', distanceKm: 285, timeHours: 6.5, startingFare: 4400 },
      { name: 'Kanyakumari to Thoothukudi', to: 'Thoothukudi', distanceKm: 115, timeHours: 2.25, startingFare: 1900 },
      { name: 'Kanyakumari to Kodaikanal', to: 'Kodaikanal', distanceKm: 340, timeHours: 6.75, startingFare: 4900 },
    ],

    fareTable: [
      { to: 'Trivandrum',  distanceKm: 85,  timeHours: 2.25, hatchback: 1800, sedan: 2100, suv: 2900 },
      { to: 'Madurai',     distanceKm: 245, timeHours: 4,    hatchback: 3200, sedan: 3700, suv: 5000 },
      { to: 'Tirunelveli', distanceKm: 85,  timeHours: 1.5,  hatchback: 1300, sedan: 1550, suv: 2150 },
      { to: 'Rameshwaram', distanceKm: 310, timeHours: 5.5,  hatchback: 4200, sedan: 4800, suv: 6500 },
      { to: 'Chennai',     distanceKm: 700, timeHours: 11.5, hatchback: 8200, sedan: 9200, suv: 12500 },
      { to: 'Kochi',       distanceKm: 285, timeHours: 6.5,  hatchback: 4400, sedan: 5000, suv: 6800 },
    ],
...
Transportation is anchored by Karur Junction (KRR)—a vital five-way railway intersection in Southern Railway—and Central Bus Stand on NH-44 and NH-81. Whether you are an international textile buyer visiting manufacturing plants, a TNPL corporate executive, or a traveler taking an express cab to Trichy Airport (TRZ - 80 km) or Coimbatore, SAMAYAS provides reliable 24/7 one-way cabs from Karur with zero return fare charges.`,
    ...
    routes: [
      { name: 'Karur to Trichy', to: 'Trichy', distanceKm: 80, timeHours: 1.5, startingFare: 1300 },
      { name: 'Karur to Coimbatore', to: 'Coimbatore', distanceKm: 130, timeHours: 2.5, startingFare: 2000 },
      { name: 'Karur to Salem', to: 'Salem', distanceKm: 85, timeHours: 1.5, startingFare: 1350 },
      { name: 'Karur to Erode', to: 'Erode', distanceKm: 65, timeHours: 1.25, startingFare: 1000 },
      { name: 'Karur to Dindigul', to: 'Dindigul', distanceKm: 75, timeHours: 1.5, startingFare: 1300 },
      { name: 'Karur to Chennai', to: 'Chennai', distanceKm: 370, timeHours: 6.25, startingFare: 4300 },
      { name: 'Karur to Bengaluru', to: 'Bengaluru', distanceKm: 290, timeHours: 5.25, startingFare: 3600 },
      { name: 'Karur to Madurai', to: 'Madurai', distanceKm: 140, timeHours: 2.75, startingFare: 2100 },
      { name: 'Karur to Namakkal', to: 'Namakkal', distanceKm: 45, timeHours: 0.8, startingFare: 750 },
    ],

    fareTable: [
      { to: 'Trichy',     distanceKm: 80,  timeHours: 1.5,  hatchback: 1300, sedan: 1550, suv: 2150 },
      { to: 'Coimbatore', distanceKm: 130, timeHours: 2.5,  hatchback: 2000, sedan: 2350, suv: 3200 },
      { to: 'Salem',      distanceKm: 85,  timeHours: 1.5,  hatchback: 1350, sedan: 1600, suv: 2200 },
      { to: 'Erode',      distanceKm: 65,  timeHours: 1.25, hatchback: 1000, sedan: 1200, suv: 1700 },
      { to: 'Chennai',    distanceKm: 370, timeHours: 6.25, hatchback: 4300, sedan: 4900, suv: 6600 },
      { to: 'Bengaluru',  distanceKm: 290, timeHours: 5.25, hatchback: 3600, sedan: 4100, suv: 5600 },
    ],
...
Historically, Krishnagiri is guarded by the majestic 16th-century Syed Basha hill fort built by Vijayanagara Emperor Krishnadevaraya, and the scenic Krishnagiri Reservoir Project (KRP Dam) across the Thenpennai river. Transportation is anchored by Hosur Railway Station (HSRA), Hosur MGR Bus Stand, and Krishnagiri Central Bus Stand. Whether you are an auto industry engineer commuting to Hosur SEZs, an agricultural merchant, or a traveler taking an airport run to Bengaluru Kempegowda Airport (BLR), SAMAYAS provides reliable 24/7 one-way cabs from Krishnagiri with zero return fare charges.`,
    ...
    routes: [
      { name: 'Krishnagiri to Bengaluru', to: 'Bengaluru', distanceKm: 90, timeHours: 1.75, startingFare: 1400 },
      { name: 'Krishnagiri to Hosur', to: 'Hosur', distanceKm: 45, timeHours: 0.8, startingFare: 750 },
      { name: 'Krishnagiri to Salem', to: 'Salem', distanceKm: 110, timeHours: 2, startingFare: 1700 },
      { name: 'Krishnagiri to Chennai', to: 'Chennai', distanceKm: 260, timeHours: 4.75, startingFare: 3300 },
      { name: 'Krishnagiri to Dharmapuri', to: 'Dharmapuri', distanceKm: 45, timeHours: 0.8, startingFare: 750 },
      { name: 'Krishnagiri to Tirupathur', to: 'Tirupathur', distanceKm: 60, timeHours: 1.2, startingFare: 1000 },
      { name: 'Krishnagiri to Vellore', to: 'Vellore', distanceKm: 120, timeHours: 2.25, startingFare: 1850 },
      { name: 'Krishnagiri to Coimbatore', to: 'Coimbatore', distanceKm: 270, timeHours: 5, startingFare: 3400 },
      { name: 'Krishnagiri to Hogenakkal', to: 'Hogenakkal', distanceKm: 85, timeHours: 2, startingFare: 1400 },
    ],

    fareTable: [
      { to: 'Bengaluru',  distanceKm: 90,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2300 },
      { to: 'Hosur',      distanceKm: 45,  timeHours: 0.8,  hatchback: 750,  sedan: 900,  suv: 1300 },
      { to: 'Salem',      distanceKm: 110, timeHours: 2,    hatchback: 1700, sedan: 1950, suv: 2700 },
      { to: 'Chennai',    distanceKm: 260, timeHours: 4.75, hatchback: 3300, sedan: 3800, suv: 5200 },
      { to: 'Vellore',    distanceKm: 120, timeHours: 2.25, hatchback: 1850, sedan: 2150, suv: 2950 },
      { to: 'Coimbatore', distanceKm: 270, timeHours: 5,    hatchback: 3400, sedan: 3900, suv: 5300 },
    ],
...
Transportation in Madurai is anchored by Madurai Junction Railway Station (MDU)—one of South India's busiest railway hubs—Mattuthavani Integrated Bus Terminus (MIBT), Arappalayam Bus Stand, and Madurai International Airport (IXM). Whether you are embarking on the sacred Rameshwaram-Kanyakumari pilgrimage circuit, heading up to Kodaikanal hills, commuting to IT parks, or catching an international flight, SAMAYAS provides reliable 24/7 one-way cabs from Madurai with zero return fare charges.`,
    ...
    routes: [
      { name: 'Madurai to Rameshwaram', to: 'Rameshwaram', distanceKm: 175, timeHours: 3.25, startingFare: 2400 },
      { name: 'Madurai to Kodaikanal', to: 'Kodaikanal', distanceKm: 115, timeHours: 3.25, startingFare: 2800 },
      { name: 'Madurai to Kanyakumari', to: 'Kanyakumari', distanceKm: 245, timeHours: 4, startingFare: 3200 },
      { name: 'Madurai to Trichy', to: 'Trichy', distanceKm: 135, timeHours: 2.25, startingFare: 1900 },
      { name: 'Madurai to Chennai', to: 'Chennai', distanceKm: 460, timeHours: 7.5, startingFare: 5200 },
      { name: 'Madurai to Coimbatore', to: 'Coimbatore', distanceKm: 215, timeHours: 4.25, startingFare: 2900 },
      { name: 'Madurai to Tirunelveli', to: 'Tirunelveli', distanceKm: 160, timeHours: 2.75, startingFare: 2200 },
      { name: 'Madurai to Theni', to: 'Theni', distanceKm: 75, timeHours: 1.5, startingFare: 1300 },
      { name: 'Madurai to Munnar', to: 'Munnar', distanceKm: 155, timeHours: 4.5, startingFare: 3400 },
    ],

    fareTable: [
      { to: 'Rameshwaram', distanceKm: 175, timeHours: 3.25, hatchback: 2400, sedan: 2750, suv: 3800 },
      { to: 'Kodaikanal',  distanceKm: 115, timeHours: 3.25, hatchback: 2800, sedan: 3200, suv: 4400 },
      { to: 'Kanyakumari', distanceKm: 245, timeHours: 4,    hatchback: 3200, sedan: 3700, suv: 5000 },
      { to: 'Trichy',      distanceKm: 135, timeHours: 2.25, hatchback: 1900, sedan: 2200, suv: 3000 },
      { to: 'Chennai',     distanceKm: 460, timeHours: 7.5,  hatchback: 5200, sedan: 5900, suv: 8000 },
      { to: 'Coimbatore',  distanceKm: 215, timeHours: 4.25, hatchback: 2900, sedan: 3300, suv: 4600 },
    ],
...
Transportation in Mayiladuthurai is anchored by Mayiladuthurai Junction Railway Station (MV)—a major railway junction connecting Chennai, Trichy, and Tanjore—alongside Sirkazhi Station (SY) and Mayiladuthurai Central Bus Stand. Whether you are undertaking a Navagraha temple pilgrimage, seeking Nadi astrology at Vaitheeswaran Kovil, visiting Thirumanancheri, or traveling to Trichy Airport, SAMAYAS provides reliable 24/7 one-way cabs from Mayiladuthurai with zero return fare charges.`,
    ...
    routes: [
      { name: 'Mayiladuthurai to Kumbakonam', to: 'Kumbakonam', distanceKm: 35, timeHours: 0.75, startingFare: 650 },
      { name: 'Mayiladuthurai to Chidambaram', to: 'Chidambaram', distanceKm: 40, timeHours: 0.8, startingFare: 750 },
      { name: 'Mayiladuthurai to Thanjavur', to: 'Thanjavur', distanceKm: 75, timeHours: 1.5, startingFare: 1300 },
      { name: 'Mayiladuthurai to Trichy', to: 'Trichy', distanceKm: 130, timeHours: 2.5, startingFare: 2000 },
      { name: 'Mayiladuthurai to Chennai', to: 'Chennai', distanceKm: 270, timeHours: 5.25, startingFare: 3500 },
      { name: 'Mayiladuthurai to Puducherry', to: 'Puducherry', distanceKm: 115, timeHours: 2.25, startingFare: 1800 },
      { name: 'Mayiladuthurai to Nagapattinam', to: 'Nagapattinam', distanceKm: 55, timeHours: 1.1, startingFare: 950 },
      { name: 'Mayiladuthurai to Velankanni', to: 'Velankanni', distanceKm: 70, timeHours: 1.4, startingFare: 1200 },
      { name: 'Mayiladuthurai to Karaikal', to: 'Karaikal', distanceKm: 60, timeHours: 1.2, startingFare: 1000 },
    ],

    fareTable: [
      { to: 'Kumbakonam', distanceKm: 35,  timeHours: 0.75, hatchback: 650,  sedan: 800,  suv: 1200 },
      { to: 'Chidambaram', distanceKm: 40,  timeHours: 0.8,  hatchback: 750,  sedan: 900,  suv: 1350 },
      { to: 'Thanjavur',  distanceKm: 75,  timeHours: 1.5,  hatchback: 1300, sedan: 1550, suv: 2150 },
      { to: 'Trichy',     distanceKm: 130, timeHours: 2.5,  hatchback: 2000, sedan: 2350, suv: 3200 },
      { to: 'Chennai',    distanceKm: 270, timeHours: 5.25, hatchback: 3500, sedan: 4000, suv: 5500 },
      { to: 'Puducherry', distanceKm: 115, timeHours: 2.25, hatchback: 1800, sedan: 2100, suv: 2900 },
    ],
...
Economically, Nagapattinam thrives on marine commercial fishing, seafood processing, CPCL oil refining, and salt production at Vedaranyam. Transportation is anchored by Nagapattinam Junction (NGT), Velankanni Railway Station (VLNK), and Nagapattinam Central Bus Stand along the East Coast Road (ECR). Whether you are embarking on a pilgrimage to Velankanni and Nagore, visiting Point Calimere, or taking an outstation journey to Chennai, Trichy Airport, or Rameshwaram, SAMAYAS provides reliable 24/7 one-way cabs from Nagapattinam with zero return fare charges.`,
    ...
    routes: [
      { name: 'Nagapattinam to Velankanni', to: 'Velankanni', distanceKm: 12, timeHours: 0.3, startingFare: 400 },
      { name: 'Nagapattinam to Thanjavur', to: 'Thanjavur', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Nagapattinam to Trichy', to: 'Trichy', distanceKm: 145, timeHours: 2.75, startingFare: 2200 },
      { name: 'Nagapattinam to Chennai', to: 'Chennai', distanceKm: 310, timeHours: 6, startingFare: 4100 },
      { name: 'Nagapattinam to Puducherry', to: 'Puducherry', distanceKm: 140, timeHours: 2.75, startingFare: 2100 },
      { name: 'Nagapattinam to Rameshwaram', to: 'Rameshwaram', distanceKm: 230, timeHours: 4.5, startingFare: 3300 },
      { name: 'Nagapattinam to Kumbakonam', to: 'Kumbakonam', distanceKm: 65, timeHours: 1.3, startingFare: 1100 },
      { name: 'Nagapattinam to Karaikal', to: 'Karaikal', distanceKm: 20, timeHours: 0.5, startingFare: 500 },
      { name: 'Nagapattinam to Madurai', to: 'Madurai', distanceKm: 210, timeHours: 4.25, startingFare: 2900 },
    ],

    fareTable: [
      { to: 'Velankanni',  distanceKm: 12,  timeHours: 0.3,  hatchback: 400,  sedan: 500,  suv: 800 },
      { to: 'Thanjavur',   distanceKm: 85,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2300 },
      { to: 'Trichy',      distanceKm: 145, timeHours: 2.75, hatchback: 2200, sedan: 2500, suv: 3500 },
      { to: 'Chennai',     distanceKm: 310, timeHours: 6,    hatchback: 4100, sedan: 4700, suv: 6300 },
      { to: 'Puducherry',  distanceKm: 140, timeHours: 2.75, hatchback: 2100, sedan: 2450, suv: 3400 },
      { to: 'Rameshwaram', distanceKm: 230, timeHours: 4.5,  hatchback: 3300, sedan: 3800, suv: 5200 },
    ],
...
Nature enthusiasts flock to Kolli Hills (Kolli Malai)—a serene mountain range famous for 70 thrilling hairpin bends, Agaya Gangai Waterfalls, fruit orchards, and the ancient Arapaleeswarar Temple. Transportation is anchored by Namakkal Railway Station (NMKL) on the Salem-Karur line and Namakkal Central Bus Stand along NH-44. Whether you are a poultry entrepreneur, transport fleet auditor, Kolli Hills trekker, or pilgrim, SAMAYAS provides reliable 24/7 one-way cabs from Namakkal with zero return fare charges.`,
    ...
    routes: [
      { name: 'Namakkal to Salem', to: 'Salem', distanceKm: 50, timeHours: 1, startingFare: 800 },
      { name: 'Namakkal to Karur', to: 'Karur', distanceKm: 45, timeHours: 0.8, startingFare: 750 },
      { name: 'Namakkal to Trichy', to: 'Trichy', distanceKm: 85, timeHours: 1.5, startingFare: 1350 },
      { name: 'Namakkal to Kolli Hills', to: 'Kolli Hills', distanceKm: 55, timeHours: 1.75, startingFare: 1500 },
      { name: 'Namakkal to Coimbatore', to: 'Coimbatore', distanceKm: 165, timeHours: 3.25, startingFare: 2400 },
      { name: 'Namakkal to Erode', to: 'Erode', distanceKm: 60, timeHours: 1.1, startingFare: 950 },
      { name: 'Namakkal to Chennai', to: 'Chennai', distanceKm: 370, timeHours: 6.25, startingFare: 4300 },
      { name: 'Namakkal to Bengaluru', to: 'Bengaluru', distanceKm: 245, timeHours: 4.25, startingFare: 3200 },
      { name: 'Namakkal to Madurai', to: 'Madurai', distanceKm: 155, timeHours: 2.75, startingFare: 2200 },
    ],

    fareTable: [
      { to: 'Salem',       distanceKm: 50,  timeHours: 1,    hatchback: 800,  sedan: 950,  suv: 1350 },
      { to: 'Karur',       distanceKm: 45,  timeHours: 0.8,  hatchback: 750,  sedan: 900,  suv: 1300 },
      { to: 'Trichy',      distanceKm: 85,  timeHours: 1.5,  hatchback: 1350, sedan: 1600, suv: 2200 },
      { to: 'Kolli Hills', distanceKm: 55,  timeHours: 1.75, hatchback: 1500, sedan: 1800, suv: 2500 },
      { to: 'Coimbatore',  distanceKm: 165, timeHours: 3.25, hatchback: 2400, sedan: 2750, suv: 3800 },
      { to: 'Bengaluru',   distanceKm: 245, timeHours: 4.25, hatchback: 3200, sedan: 3650, suv: 5000 },
    ],
...
Navigating mountain roads requires specialized skill. SAMAYAS employs expert mountain drivers trained specifically in navigating the 36 hairpin bends of the Mettupalayam ghat road, Kotagiri curves, and Gudalur forest passes. Transportation in Nilgiris is anchored by Ooty Central Bus Stand (ATC), Coonoor Station (ONR), and Mettupalayam Railway Station (MTP) at the foothills, with Coimbatore International Airport (CJB) just 88 km away from Coonoor. Whether you are taking an outstation hill descent to Coimbatore Airport, traveling to Mysuru, Wayanad, or Bengaluru, SAMAYAS provides reliable 24/7 one-way cabs from Nilgiris with zero return fare charges.`,
    ...
    routes: [
      { name: 'Ooty to Coimbatore Airport', to: 'Coimbatore Airport', distanceKm: 85, timeHours: 3, startingFare: 2400 },
      { name: 'Ooty to Mettupalayam', to: 'Mettupalayam', distanceKm: 50, timeHours: 2, startingFare: 1600 },
      { name: 'Ooty to Mysuru', to: 'Mysuru', distanceKm: 125, timeHours: 3.5, startingFare: 2900 },
      { name: 'Ooty to Bengaluru', to: 'Bengaluru', distanceKm: 270, timeHours: 6.5, startingFare: 4800 },
      { name: 'Ooty to Wayanad', to: 'Wayanad', distanceKm: 110, timeHours: 3.25, startingFare: 2700 },
      { name: 'Ooty to Salem', to: 'Salem', distanceKm: 165, timeHours: 4.5, startingFare: 3600 },
      { name: 'Ooty to Chennai', to: 'Chennai', distanceKm: 540, timeHours: 10.5, startingFare: 7500 },
      { name: 'Ooty to Kochi', to: 'Kochi', distanceKm: 280, timeHours: 7.5, startingFare: 5200 },
      { name: 'Ooty to Erode', to: 'Erode', distanceKm: 140, timeHours: 4, startingFare: 3200 },
    ],

    fareTable: [
      { to: 'Coimbatore Airport', distanceKm: 85,  timeHours: 3,    hatchback: 2400, sedan: 2800, suv: 3900 },
      { to: 'Mettupalayam',       distanceKm: 50,  timeHours: 2,    hatchback: 1600, sedan: 1900, suv: 2600 },
      { to: 'Mysuru',             distanceKm: 125, timeHours: 3.5,  hatchback: 2900, sedan: 3400, suv: 4600 },
      { to: 'Bengaluru',          distanceKm: 270, timeHours: 6.5,  hatchback: 4800, sedan: 5500, suv: 7400 },
      { to: 'Wayanad',            distanceKm: 110, timeHours: 3.25, hatchback: 2700, sedan: 3100, suv: 4300 },
      { to: 'Salem',              distanceKm: 165, timeHours: 4.5,  hatchback: 3600, sedan: 4100, suv: 5600 },
    ],
...
Historically, Perambalur features the imposing 17th-century Ranjankudi Fort—a well-preserved granite fortress built by the Nawab of the Carnatic that witnessed historic Anglo-French battles. Transportation is anchored by Perambalur Central Bus Stand on NH-45, with Tiruchirappalli International Airport (TRZ) located just 55 km south. Whether you are an MRF industrial executive, an educational delegate, or a traveler taking an express cab to Trichy Airport or Chennai, SAMAYAS provides reliable 24/7 one-way cabs from Perambalur with zero return fare charges.`,
    ...
    routes: [
      { name: 'Perambalur to Trichy', to: 'Trichy', distanceKm: 55, timeHours: 1, startingFare: 900 },
      { name: 'Perambalur to Chennai', to: 'Chennai', distanceKm: 280, timeHours: 4.75, startingFare: 3600 },
      { name: 'Perambalur to Salem', to: 'Salem', distanceKm: 105, timeHours: 2, startingFare: 1650 },
      { name: 'Perambalur to Ariyalur', to: 'Ariyalur', distanceKm: 30, timeHours: 0.6, startingFare: 550 },
      { name: 'Perambalur to Kallakurichi', to: 'Kallakurichi', distanceKm: 65, timeHours: 1.25, startingFare: 1050 },
      { name: 'Perambalur to Puducherry', to: 'Puducherry', distanceKm: 145, timeHours: 2.75, startingFare: 2200 },
      { name: 'Perambalur to Coimbatore', to: 'Coimbatore', distanceKm: 215, timeHours: 4.25, startingFare: 2900 },
      { name: 'Perambalur to Thanjavur', to: 'Thanjavur', distanceKm: 95, timeHours: 1.75, startingFare: 1500 },
      { name: 'Perambalur to Madurai', to: 'Madurai', distanceKm: 185, timeHours: 3.25, startingFare: 2600 },
    ],

    fareTable: [
      { to: 'Trichy',     distanceKm: 55,  timeHours: 1,    hatchback: 900,  sedan: 1100, suv: 1550 },
      { to: 'Chennai',    distanceKm: 280, timeHours: 4.75, hatchback: 3600, sedan: 4100, suv: 5600 },
      { to: 'Salem',      distanceKm: 105, timeHours: 2,    hatchback: 1650, sedan: 1900, suv: 2600 },
      { to: 'Ariyalur',   distanceKm: 30,  timeHours: 0.6,  hatchback: 550,  sedan: 700,  suv: 1000 },
      { to: 'Puducherry', distanceKm: 145, timeHours: 2.75, hatchback: 2200, sedan: 2500, suv: 3500 },
      { to: 'Coimbatore', distanceKm: 215, timeHours: 4.25, hatchback: 2900, sedan: 3300, suv: 4600 },
    ],
...
Transportation in Pudukkottai is anchored by Pudukkottai Railway Station (PDKT) and Pudukkottai Central Bus Stand along NH-336 and NH-536, with Tiruchirappalli International Airport (TRZ) located just 50 km north. Whether you are exploring rock-cut architecture, visiting Chettinad heritage mansions, traveling to Trichy Airport, or taking an outstation journey to Rameshwaram, SAMAYAS provides reliable 24/7 one-way cabs from Pudukkottai with zero return fare charges.`,
    ...
    routes: [
      { name: 'Pudukkottai to Trichy Airport', to: 'Trichy Airport', distanceKm: 50, timeHours: 1, startingFare: 850 },
      { name: 'Pudukkottai to Madurai', to: 'Madurai', distanceKm: 105, timeHours: 2, startingFare: 1650 },
      { name: 'Pudukkottai to Thanjavur', to: 'Thanjavur', distanceKm: 55, timeHours: 1.1, startingFare: 900 },
      { name: 'Pudukkottai to Chettinad', to: 'Chettinad', distanceKm: 35, timeHours: 0.75, startingFare: 650 },
      { name: 'Pudukkottai to Rameshwaram', to: 'Rameshwaram', distanceKm: 165, timeHours: 3.25, startingFare: 2400 },
      { name: 'Pudukkottai to Chennai', to: 'Chennai', distanceKm: 390, timeHours: 6.5, startingFare: 4500 },
      { name: 'Pudukkottai to Karaikudi', to: 'Karaikudi', distanceKm: 40, timeHours: 0.8, startingFare: 700 },
      { name: 'Pudukkottai to Coimbatore', to: 'Coimbatore', distanceKm: 260, timeHours: 5, startingFare: 3400 },
      { name: 'Pudukkottai to Dindigul', to: 'Dindigul', distanceKm: 120, timeHours: 2.25, startingFare: 1800 },
    ],

    fareTable: [
      { to: 'Trichy Airport', distanceKm: 50,  timeHours: 1,    hatchback: 850,  sedan: 1050, suv: 1500 },
      { to: 'Madurai',        distanceKm: 105, timeHours: 2,    hatchback: 1650, sedan: 1950, suv: 2700 },
      { to: 'Thanjavur',      distanceKm: 55,  timeHours: 1.1,  hatchback: 900,  sedan: 1100, suv: 1550 },
      { to: 'Chettinad',      distanceKm: 35,  timeHours: 0.75, hatchback: 650,  sedan: 800,  suv: 1200 },
      { to: 'Rameshwaram',    distanceKm: 165, timeHours: 3.25, hatchback: 2400, sedan: 2750, suv: 3800 },
      { to: 'Chennai',        distanceKm: 390, timeHours: 6.5,  hatchback: 4500, sedan: 5100, suv: 7000 },
    ],
...
Transportation in Ramanathapuram is anchored by Ramanathapuram Railway Station (RMD), Rameshwaram Railway Station (RMM), and Ramanathapuram Central Bus Stand on NH-87, with Madurai International Airport (IXM) located 115 km west. Whether you are embarking on the Char Dham Rameshwaram pilgrimage, visiting Dhanushkodi beach, exploring Pamban Bridge, or taking an outstation taxi to Madurai, Trichy, or Kanyakumari, SAMAYAS provides reliable 24/7 one-way cabs from Ramanathapuram with zero return fare charges.`,
    ...
    routes: [
      { name: 'Ramanathapuram to Rameshwaram', to: 'Rameshwaram', distanceKm: 55, timeHours: 1.1, startingFare: 900 },
      { name: 'Ramanathapuram to Madurai', to: 'Madurai', distanceKm: 115, timeHours: 2.25, startingFare: 1700 },
      { name: 'Ramanathapuram to Dhanushkodi', to: 'Dhanushkodi', distanceKm: 75, timeHours: 1.75, startingFare: 1300 },
      { name: 'Ramanathapuram to Trichy', to: 'Trichy', distanceKm: 175, timeHours: 3.5, startingFare: 2500 },
      { name: 'Ramanathapuram to Kanyakumari', to: 'Kanyakumari', distanceKm: 310, timeHours: 5.5, startingFare: 4200 },
      { name: 'Ramanathapuram to Chennai', to: 'Chennai', distanceKm: 530, timeHours: 9.25, startingFare: 6800 },
      { name: 'Ramanathapuram to Thoothukudi', to: 'Thoothukudi', distanceKm: 140, timeHours: 2.75, startingFare: 2100 },
      { name: 'Ramanathapuram to Tirunelveli', to: 'Tirunelveli', distanceKm: 190, timeHours: 3.75, startingFare: 2800 },
      { name: 'Ramanathapuram to Coimbatore', to: 'Coimbatore', distanceKm: 330, timeHours: 6.5, startingFare: 4500 },
    ],

    fareTable: [
      { to: 'Rameshwaram', distanceKm: 55,  timeHours: 1.1,  hatchback: 900,  sedan: 1100, suv: 1550 },
      { to: 'Madurai',     distanceKm: 115, timeHours: 2.25, hatchback: 1700, sedan: 2000, suv: 2800 },
      { to: 'Dhanushkodi', distanceKm: 75,  timeHours: 1.75, hatchback: 1300, sedan: 1550, suv: 2200 },
      { to: 'Trichy',      distanceKm: 175, timeHours: 3.5,  hatchback: 2500, sedan: 2900, suv: 4000 },
      { to: 'Kanyakumari', distanceKm: 310, timeHours: 5.5,  hatchback: 4200, sedan: 4800, suv: 6500 },
      { to: 'Chennai',     distanceKm: 530, timeHours: 9.25, hatchback: 6800, sedan: 7800, suv: 10500 },
    ],
...
Historically, Ranipet district encompasses historic Arcot—the ancient capital of the Nawabs of the Carnatic, famous for Arot Nawab Biryani—and the hill shrine of Sholinghur Arulmigu Lakshmi Narasimha Swamy Temple. Transportation is anchored by Mukundarayapuram Railway Station (MCN), Walajah Road Junction (WJR), and Ranipet Bus Stand, with Chennai International Airport (MAA) located 100 km east. Whether you are an international leather buyer, a BHEL engineer, or a commuter booking an express cab to Chennai Airport or Tirupati, SAMAYAS provides reliable 24/7 one-way cabs from Ranipet with zero return fare charges.`,
    ...
    routes: [
      { name: 'Ranipet to Chennai Airport', to: 'Chennai Airport', distanceKm: 95, timeHours: 1.75, startingFare: 1500 },
      { name: 'Ranipet to Chennai City', to: 'Chennai City', distanceKm: 105, timeHours: 2.25, startingFare: 1700 },
      { name: 'Ranipet to Vellore', to: 'Vellore', distanceKm: 25, timeHours: 0.5, startingFare: 500 },
      { name: 'Ranipet to Kanchipuram', to: 'Kanchipuram', distanceKm: 35, timeHours: 0.75, startingFare: 650 },
      { name: 'Ranipet to Bengaluru', to: 'Bengaluru', distanceKm: 230, timeHours: 4.25, startingFare: 3100 },
      { name: 'Ranipet to Tirupati', to: 'Tirupati', distanceKm: 105, timeHours: 2.25, startingFare: 1900 },
      { name: 'Ranipet to Puducherry', to: 'Puducherry', distanceKm: 135, timeHours: 2.75, startingFare: 2100 },
      { name: 'Ranipet to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Ranipet to Salem', to: 'Salem', distanceKm: 235, timeHours: 4.25, startingFare: 3200 },
    ],

    fareTable: [
      { to: 'Chennai Airport', distanceKm: 95,  timeHours: 1.75, hatchback: 1500, sedan: 1750, suv: 2400 },
      { to: 'Chennai City',    distanceKm: 105, timeHours: 2.25, hatchback: 1700, sedan: 1950, suv: 2700 },
      { to: 'Vellore',         distanceKm: 25,  timeHours: 0.5,  hatchback: 500,  sedan: 650,  suv: 950 },
      { to: 'Kanchipuram',     distanceKm: 35,  timeHours: 0.75, hatchback: 650,  sedan: 800,  suv: 1200 },
      { to: 'Bengaluru',       distanceKm: 230, timeHours: 4.25, hatchback: 3100, sedan: 3500, suv: 4800 },
      { to: 'Tirupati',        distanceKm: 105, timeHours: 2.25, hatchback: 1900, sedan: 2200, suv: 3000 },
    ],
...
Transportation in Salem is anchored by Salem Junction Railway Station (SA)—a major division headquarters connecting North and South India—Salem Domestic Airport (SXV), and Salem New Integrated Bus Stand (Meyyanur) at the junction of NH-44 and NH-79. Whether you are an industrial executive visiting SAIL steel plant, a sago merchant, a tourist driving up 20 hairpin bends to Yercaud, or a traveler commuting to Bengaluru, Coimbatore, or Chennai, SAMAYAS provides reliable 24/7 one-way cabs from Salem with zero return fare charges.`,
    ...
    routes: [
      { name: 'Salem to Yercaud', to: 'Yercaud', distanceKm: 30, timeHours: 1, startingFare: 800 },
      { name: 'Salem to Bengaluru', to: 'Bengaluru', distanceKm: 200, timeHours: 3.5, startingFare: 2700 },
      { name: 'Salem to Coimbatore', to: 'Coimbatore', distanceKm: 160, timeHours: 3, startingFare: 2200 },
      { name: 'Salem to Chennai', to: 'Chennai', distanceKm: 340, timeHours: 5.75, startingFare: 4000 },
      { name: 'Salem to Erode', to: 'Erode', distanceKm: 65, timeHours: 1.25, startingFare: 1000 },
      { name: 'Salem to Trichy', to: 'Trichy', distanceKm: 140, timeHours: 2.75, startingFare: 2100 },
      { name: 'Salem to Namakkal', to: 'Namakkal', distanceKm: 50, timeHours: 1, startingFare: 800 },
      { name: 'Salem to Dharmapuri', to: 'Dharmapuri', distanceKm: 68, timeHours: 1.25, startingFare: 1100 },
      { name: 'Salem to Mettur Dam', to: 'Mettur Dam', distanceKm: 50, timeHours: 1, startingFare: 850 },
    ],

    fareTable: [
      { to: 'Yercaud',    distanceKm: 30,  timeHours: 1,    hatchback: 800,  sedan: 1000, suv: 1450 },
      { to: 'Bengaluru',  distanceKm: 200, timeHours: 3.5,  hatchback: 2700, sedan: 3100, suv: 4300 },
      { to: 'Coimbatore', distanceKm: 160, timeHours: 3,    hatchback: 2200, sedan: 2500, suv: 3500 },
      { to: 'Chennai',    distanceKm: 340, timeHours: 5.75, hatchback: 4000, sedan: 4600, suv: 6200 },
      { to: 'Erode',      distanceKm: 65,  timeHours: 1.25, hatchback: 1000, sedan: 1200, suv: 1700 },
      { to: 'Trichy',     distanceKm: 140, timeHours: 2.75, hatchback: 2100, sedan: 2400, suv: 3300 },
    ],
...
Spiritually, Sivaganga is home to Pillayarpatti Arulmigu Karpaga Vinayagar 1,600-year-old rock-cut cave temple, Kundrakudi Murugan Temple, and Kalaiyarkoil. Transportation is anchored by Karaikudi Junction (KKDI), Sivaganga Station (SVGA), and Manamadurai Junction (MNM), with Madurai International Airport (IXM) located just 45 km away. Whether you are exploring Chettinad palatial mansions, visiting Keezhadi Museum, buying Athangudi tiles, or taking an outstation transfer to Madurai Airport, Trichy, or Rameshwaram, SAMAYAS provides reliable 24/7 one-way cabs from Sivaganga with zero return fare charges.`,
    ...
    routes: [
      { name: 'Sivaganga to Madurai Airport', to: 'Madurai Airport', distanceKm: 48, timeHours: 1, startingFare: 850 },
      { name: 'Karaikudi to Trichy', to: 'Trichy', distanceKm: 90, timeHours: 1.75, startingFare: 1400 },
      { name: 'Sivaganga to Rameshwaram', to: 'Rameshwaram', distanceKm: 135, timeHours: 2.75, startingFare: 2100 },
      { name: 'Sivaganga to Pudukkottai', to: 'Pudukkottai', distanceKm: 40, timeHours: 0.8, startingFare: 700 },
      { name: 'Sivaganga to Thanjavur', to: 'Thanjavur', distanceKm: 110, timeHours: 2.1, startingFare: 1600 },
      { name: 'Sivaganga to Chennai', to: 'Chennai', distanceKm: 420, timeHours: 7.25, startingFare: 4900 },
      { name: 'Sivaganga to Coimbatore', to: 'Coimbatore', distanceKm: 245, timeHours: 4.75, startingFare: 3300 },
      { name: 'Sivaganga to Kanyakumari', to: 'Kanyakumari', distanceKm: 290, timeHours: 5.25, startingFare: 4100 },
      { name: 'Sivaganga to Dindigul', to: 'Dindigul', distanceKm: 105, timeHours: 2.1, startingFare: 1650 },
    ],

    fareTable: [
      { to: 'Madurai Airport', distanceKm: 48,  timeHours: 1,    hatchback: 850,  sedan: 1050, suv: 1500 },
      { to: 'Trichy',          distanceKm: 90,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2300 },
      { to: 'Rameshwaram',     distanceKm: 135, timeHours: 2.75, hatchback: 2100, sedan: 2450, suv: 3400 },
      { to: 'Pudukkottai',     distanceKm: 40,  timeHours: 0.8,  hatchback: 700,  sedan: 850,  suv: 1250 },
      { to: 'Thanjavur',       distanceKm: 110, timeHours: 2.1,  hatchback: 1600, sedan: 1900, suv: 2700 },
      { to: 'Chennai',         distanceKm: 420, timeHours: 7.25, hatchback: 4900, sedan: 5600, suv: 7700 },
    ],
...
Transportation in Tenkasi is anchored by Tenkasi Junction (TSI), Sengottai Railway Station (SCT) along the scenic Punalur mountain rail line, and Tenkasi Central Bus Stand, with Trivandrum International Airport (TRV) just 105 km away across the Shenkottai Pass and Tuticorin Airport (TCR) 95 km east. Whether you are taking a monsoon family vacation to Courtallam waterfalls, attending temple festivals, or traveling across the Kerala border to Trivandrum Airport, SAMAYAS provides reliable 24/7 one-way cabs from Tenkasi with zero return fare charges.`,
    ...
    routes: [
      { name: 'Tenkasi to Courtallam', to: 'Courtallam', distanceKm: 6, timeHours: 0.2, startingFare: 300 },
      { name: 'Tenkasi to Tirunelveli', to: 'Tirunelveli', distanceKm: 55, timeHours: 1.1, startingFare: 900 },
      { name: 'Tenkasi to Trivandrum Airport', to: 'Trivandrum Airport', distanceKm: 105, timeHours: 2.75, startingFare: 2100 },
      { name: 'Tenkasi to Madurai', to: 'Madurai', distanceKm: 160, timeHours: 3.1, startingFare: 2400 },
      { name: 'Tenkasi to Kanyakumari', to: 'Kanyakumari', distanceKm: 130, timeHours: 2.75, startingFare: 2000 },
      { name: 'Tenkasi to Tuticorin Airport', to: 'Tuticorin Airport', distanceKm: 95, timeHours: 2, startingFare: 1600 },
      { name: 'Tenkasi to Kollam', to: 'Kollam', distanceKm: 100, timeHours: 2.5, startingFare: 1900 },
      { name: 'Tenkasi to Chennai', to: 'Chennai', distanceKm: 620, timeHours: 10.5, startingFare: 7200 },
      { name: 'Tenkasi to Coimbatore', to: 'Coimbatore', distanceKm: 320, timeHours: 6.25, startingFare: 4400 },
    ],

    fareTable: [
      { to: 'Courtallam',          distanceKm: 6,   timeHours: 0.2,  hatchback: 300,  sedan: 400,  suv: 650 },
      { to: 'Tirunelveli',         distanceKm: 55,  timeHours: 1.1,  hatchback: 900,  sedan: 1100, suv: 1550 },
      { to: 'Trivandrum Airport', distanceKm: 105, timeHours: 2.75, hatchback: 2100, sedan: 2450, suv: 3500 },
      { to: 'Madurai',             distanceKm: 160, timeHours: 3.1,  hatchback: 2400, sedan: 2750, suv: 3800 },
      { to: 'Kanyakumari',         distanceKm: 130, timeHours: 2.75, hatchback: 2000, sedan: 2300, suv: 3200 },
      { to: 'Tuticorin Airport',   distanceKm: 95,  timeHours: 2,    hatchback: 1600, sedan: 1850, suv: 2600 },
    ],
...
World-renowned for GI-tagged traditional handicrafts—including Thanjavur Art Plates, Thanjavur Dancing Dolls (Thalaiyatti Bommai), hand-carved Saraswathi Veenai, and Swamimalai bronze icon casting—the district is a center for arts and agriculture. Transportation is anchored by Thanjavur Junction (TJ), Kumbakonam Railway Station (KMU), and Thanjavur New Bus Stand, with Tiruchirappalli International Airport (TRZ) located just 55 km west. Whether you are exploring Chola architecture, taking a Navagraha temple tour, visiting Thiruvaiyaru, or catching a flight from Trichy Airport, SAMAYAS provides reliable 24/7 one-way cabs from Thanjavur with zero return fare charges.`,
    ...
    routes: [
      { name: 'Thanjavur to Trichy Airport', to: 'Trichy Airport', distanceKm: 55, timeHours: 1, startingFare: 900 },
      { name: 'Thanjavur to Kumbakonam', to: 'Kumbakonam', distanceKm: 40, timeHours: 0.8, startingFare: 700 },
      { name: 'Thanjavur to Madurai', to: 'Madurai', distanceKm: 190, timeHours: 3.5, startingFare: 2600 },
      { name: 'Thanjavur to Chennai', to: 'Chennai', distanceKm: 340, timeHours: 6, startingFare: 4200 },
      { name: 'Thanjavur to Velankanni', to: 'Velankanni', distanceKm: 90, timeHours: 1.75, startingFare: 1450 },
      { name: 'Thanjavur to Pudukkottai', to: 'Pudukkottai', distanceKm: 55, timeHours: 1.1, startingFare: 900 },
      { name: 'Thanjavur to Coimbatore', to: 'Coimbatore', distanceKm: 270, timeHours: 5.25, startingFare: 3600 },
      { name: 'Thanjavur to Salem', to: 'Salem', distanceKm: 140, timeHours: 2.75, startingFare: 2100 },
      { name: 'Thanjavur to Rameshwaram', to: 'Rameshwaram', distanceKm: 220, timeHours: 4.25, startingFare: 3100 },
    ],

    fareTable: [
      { to: 'Trichy Airport', distanceKm: 55,  timeHours: 1,    hatchback: 900,  sedan: 1100, suv: 1550 },
      { to: 'Kumbakonam',     distanceKm: 40,  timeHours: 0.8,  hatchback: 700,  sedan: 850,  suv: 1250 },
      { to: 'Madurai',        distanceKm: 190, timeHours: 3.5,  hatchback: 2600, sedan: 3000, suv: 4200 },
      { to: 'Chennai',        distanceKm: 340, timeHours: 6,    hatchback: 4200, sedan: 4800, suv: 6600 },
      { to: 'Velankanni',     distanceKm: 90,  timeHours: 1.75, hatchback: 1450, sedan: 1700, suv: 2400 },
      { to: 'Pudukkottai',    distanceKm: 55,  timeHours: 1.1,  hatchback: 900,  sedan: 1100, suv: 1550 },
    ],
...
Transportation in Theni is anchored by Bodinayakanur Railway Station (BDNK), Theni New Bus Stand along NH-85 (Kochi-Dhanushkodi Highway), and the Bodi-Munnar ghat road, with Madurai International Airport (IXM) located 80 km east. Whether you are taking a hill vacation to Munnar or Meghamalai, buying spices in Bodi, exploring Cumbum grape vineyards, or booking a direct airport transfer to Madurai or Kochi, SAMAYAS provides reliable 24/7 one-way cabs from Theni with zero return fare charges.`,
    ...
    routes: [
      { name: 'Theni to Munnar', to: 'Munnar', distanceKm: 85, timeHours: 2.75, startingFare: 2200 },
      { name: 'Theni to Madurai Airport', to: 'Madurai Airport', distanceKm: 80, timeHours: 1.5, startingFare: 1350 },
      { name: 'Theni to Meghamalai', to: 'Meghamalai', distanceKm: 70, timeHours: 2.5, startingFare: 2000 },
      { name: 'Theni to Thekkady', to: 'Thekkady', distanceKm: 60, timeHours: 1.75, startingFare: 1500 },
      { name: 'Theni to Kodaikanal', to: 'Kodaikanal', distanceKm: 85, timeHours: 2.75, startingFare: 2200 },
      { name: 'Theni to Dindigul', to: 'Dindigul', distanceKm: 75, timeHours: 1.5, startingFare: 1250 },
      { name: 'Theni to Kochi', to: 'Kochi', distanceKm: 175, timeHours: 4.5, startingFare: 3200 },
      { name: 'Theni to Chennai', to: 'Chennai', distanceKm: 510, timeHours: 9, startingFare: 6200 },
      { name: 'Theni to Coimbatore', to: 'Coimbatore', distanceKm: 195, timeHours: 4, startingFare: 2800 },
    ],

    fareTable: [
      { to: 'Munnar',          distanceKm: 85,  timeHours: 2.75, hatchback: 2200, sedan: 2550, suv: 3600 },
      { to: 'Madurai Airport', distanceKm: 80,  timeHours: 1.5,  hatchback: 1350, sedan: 1600, suv: 2200 },
      { to: 'Meghamalai',      distanceKm: 70,  timeHours: 2.5,  hatchback: 2000, sedan: 2350, suv: 3300 },
      { to: 'Thekkady',        distanceKm: 60,  timeHours: 1.75, hatchback: 1500, sedan: 1750, suv: 2500 },
      { to: 'Kodaikanal',      distanceKm: 85,  timeHours: 2.75, hatchback: 2200, sedan: 2550, suv: 3600 },
      { to: 'Kochi',           distanceKm: 175, timeHours: 4.5,  hatchback: 3200, sedan: 3650, suv: 5000 },
    ],
...
Historically, the district is the proud birthplace of freedom fighters V.O. Chidambaram Pillai ('Kappalottiya Tamilan') in Ottapidaram and Mahakavi Subramania Bharati in Ettayapuram, alongside the ancient 8th-century Pandya rock-cut temple at Kalugumalai. Transportation is anchored by Tuticorin Airport (TCR - Vagaikulam), Tuticorin Railway Station (TN), Tiruchendur Station (TCN), Kovilpatti Station (CVP), and Tuticorin New Bus Stand on NH-138. Whether you are taking a seashore pilgrimage to Tiruchendur Temple, attending shipping logistics meetings at VOC Port, buying salt/seafood, or taking a direct flight from Tuticorin Airport, SAMAYAS provides reliable 24/7 one-way cabs from Thoothukudi with zero return fare charges.`,
    ...
    routes: [
      { name: 'Thoothukudi to Tiruchendur', to: 'Tiruchendur', distanceKm: 40, timeHours: 0.8, startingFare: 700 },
      { name: 'Thoothukudi to Tirunelveli', to: 'Tirunelveli', distanceKm: 50, timeHours: 1, startingFare: 850 },
      { name: 'Thoothukudi to Madurai', to: 'Madurai', distanceKm: 150, timeHours: 2.75, startingFare: 2200 },
      { name: 'Thoothukudi to Kanyakumari', to: 'Kanyakumari', distanceKm: 115, timeHours: 2.25, startingFare: 1800 },
      { name: 'Thoothukudi to Chennai', to: 'Chennai', distanceKm: 600, timeHours: 10, startingFare: 7200 },
      { name: 'Thoothukudi to Rameshwaram', to: 'Rameshwaram', distanceKm: 160, timeHours: 3.25, startingFare: 2400 },
      { name: 'Thoothukudi to Trivandrum', to: 'Trivandrum', distanceKm: 195, timeHours: 4.25, startingFare: 3000 },
      { name: 'Thoothukudi to Coimbatore', to: 'Coimbatore', distanceKm: 360, timeHours: 6.5, startingFare: 4900 },
      { name: 'Thoothukudi to Nagercoil', to: 'Nagercoil', distanceKm: 125, timeHours: 2.5, startingFare: 1900 },
    ],

    fareTable: [
      { to: 'Tiruchendur', distanceKm: 40,  timeHours: 0.8,  hatchback: 700,  sedan: 850,  suv: 1250 },
      { to: 'Tirunelveli', distanceKm: 50,  timeHours: 1,    hatchback: 850,  sedan: 1050, suv: 1500 },
      { to: 'Madurai',    distanceKm: 150, timeHours: 2.75, hatchback: 2200, sedan: 2500, suv: 3500 },
      { to: 'Kanyakumari',distanceKm: 115, timeHours: 2.25, hatchback: 1800, sedan: 2100, suv: 3000 },
      { to: 'Chennai',    distanceKm: 600, timeHours: 10,   hatchback: 7200, sedan: 8200, suv: 11000 },
      { to: 'Rameshwaram',distanceKm: 160, timeHours: 3.25, hatchback: 2400, sedan: 2800, suv: 3900 },
    ],
...
Tirunelveli is equally famous for its mouth-watering wheat halwa prepared with Thamirabarani river water. Transportation is anchored by Tirunelveli Junction (TEN)—a major rail division hub in Southern Railway—Palayamkottai Station, and Tirunelveli New Bus Stand (Vellemeedu) on NH-44, with Tuticorin Airport (TCR - Vagaikulam) just 40 km east and Trivandrum Airport (TRV) 130 km southwest. Whether you are buying authentic Tirunelveli halwa, exploring Nellaiappar Temple, visiting Manjolai Hills, or catching a flight from Tuticorin or Trivandrum Airport, SAMAYAS provides reliable 24/7 one-way cabs from Tirunelveli with zero return fare charges.`,
    ...
    routes: [
      { name: 'Tirunelveli to Tuticorin Airport', to: 'Tuticorin Airport', distanceKm: 40, timeHours: 0.75, startingFare: 700 },
      { name: 'Tirunelveli to Kanyakumari', to: 'Kanyakumari', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Tirunelveli to Madurai', to: 'Madurai', distanceKm: 160, timeHours: 2.75, startingFare: 2200 },
      { name: 'Tirunelveli to Trivandrum Airport', to: 'Trivandrum Airport', distanceKm: 130, timeHours: 3.25, startingFare: 2400 },
      { name: 'Tirunelveli to Courtallam', to: 'Courtallam', distanceKm: 55, timeHours: 1.1, startingFare: 900 },
      { name: 'Tirunelveli to Nagercoil', to: 'Nagercoil', distanceKm: 75, timeHours: 1.5, startingFare: 1250 },
      { name: 'Tirunelveli to Chennai', to: 'Chennai', distanceKm: 620, timeHours: 9.75, startingFare: 7200 },
      { name: 'Tirunelveli to Rameshwaram', to: 'Rameshwaram', distanceKm: 190, timeHours: 3.75, startingFare: 2800 },
      { name: 'Tirunelveli to Coimbatore', to: 'Coimbatore', distanceKm: 360, timeHours: 6.25, startingFare: 4900 },
    ],

    fareTable: [
      { to: 'Tuticorin Airport',   distanceKm: 40,  timeHours: 0.75, hatchback: 700,  sedan: 850,  suv: 1250 },
      { to: 'Kanyakumari',         distanceKm: 85,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2350 },
      { to: 'Madurai',             distanceKm: 160, timeHours: 2.75, hatchback: 2200, sedan: 2550, suv: 3600 },
      { to: 'Trivandrum Airport', distanceKm: 130, timeHours: 3.25, hatchback: 2400, sedan: 2800, suv: 3900 },
      { to: 'Courtallam',          distanceKm: 55,  timeHours: 1.1,  hatchback: 900,  sedan: 1100, suv: 1550 },
      { to: 'Nagercoil',           distanceKm: 75,  timeHours: 1.5,  hatchback: 1250, sedan: 1450, suv: 2050 },
    ],
...
Tirupattur district is internationally famous for leather shoe manufacturing and exports in Ambur and Vaniyambadi, the world-renowned Ambur Biryani culinary tradition, and the Vainu Bappu Observatory in Kavalur (housing Asia's second-largest 2.3-meter optical telescope operated by the Indian Institute of Astrophysics). Aligned along the Chennai-Bengaluru expressway (NH-48), with Bengaluru Kempegowda Airport (BLR) 165 km west and Chennai Airport (MAA) 210 km east. Whether you are taking a weekend hill trip to Yelagiri, visiting Jolarpettai Junction, attending leather trade meetings in Ambur, or booking a direct airport transfer to Bengaluru or Chennai, SAMAYAS provides reliable 24/7 one-way cabs from Tirupattur with zero return fare charges.`,
    ...
    routes: [
      { name: 'Tirupattur to Yelagiri Hills', to: 'Yelagiri Hills', distanceKm: 28, timeHours: 0.75, startingFare: 750 },
      { name: 'Tirupattur to Bengaluru', to: 'Bengaluru', distanceKm: 145, timeHours: 2.75, startingFare: 2100 },
      { name: 'Tirupattur to Chennai Airport', to: 'Chennai Airport', distanceKm: 210, timeHours: 3.75, startingFare: 3100 },
      { name: 'Tirupattur to Vellore', to: 'Vellore', distanceKm: 85, timeHours: 1.5, startingFare: 1350 },
      { name: 'Tirupattur to Krishnagiri', to: 'Krishnagiri', distanceKm: 45, timeHours: 0.8, startingFare: 750 },
      { name: 'Tirupattur to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Tirupattur to Salem', to: 'Salem', distanceKm: 135, timeHours: 2.5, startingFare: 2100 },
      { name: 'Tirupattur to Tirupati', to: 'Tirupati', distanceKm: 175, timeHours: 3.5, startingFare: 2600 },
      { name: 'Tirupattur to Hosur', to: 'Hosur', distanceKm: 90, timeHours: 1.75, startingFare: 1450 },
    ],

    fareTable: [
      { to: 'Yelagiri Hills',   distanceKm: 28,  timeHours: 0.75, hatchback: 750,  sedan: 900,  suv: 1350 },
      { to: 'Bengaluru',        distanceKm: 145, timeHours: 2.75, hatchback: 2100, sedan: 2450, suv: 3400 },
      { to: 'Chennai Airport',  distanceKm: 210, timeHours: 3.75, hatchback: 3100, sedan: 3600, suv: 4900 },
      { to: 'Vellore',          distanceKm: 85,  timeHours: 1.5,  hatchback: 1350, sedan: 1600, suv: 2200 },
      { to: 'Krishnagiri',      distanceKm: 45,  timeHours: 0.8,  hatchback: 750,  sedan: 900,  suv: 1300 },
      { to: 'Tiruvannamalai',   distanceKm: 85,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2300 },
    ],
...
Nature enthusiasts and travelers explore Amaravathi Dam & Crocodile Bank in Udumalpet, Thirumoorthy Hills & Waterfalls, Kangeyam (famous for Kangeyam bull breeding), and Uthukuli (world-famous for organic Ghee and Butter). Transportation is anchored by Tiruppur Railway Station (TUP) on the Salem-Coimbatore main trunk line, Udumalpet Station (UDT), and Tiruppur New Bus Stand, with Coimbatore International Airport (CJB) located just 45 km west. Whether you are an international garment buyer, textile mill owner, pilgrim visiting Avinashi, or a traveler taking an express cab to Coimbatore Airport or Ooty, SAMAYAS provides reliable 24/7 one-way cabs from Tiruppur with zero return fare charges.`,
    ...
    routes: [
      { name: 'Tiruppur to Coimbatore Airport', to: 'Coimbatore Airport', distanceKm: 45, timeHours: 1, startingFare: 800 },
      { name: 'Tiruppur to Coimbatore City', to: 'Coimbatore City', distanceKm: 55, timeHours: 1.25, startingFare: 950 },
      { name: 'Tiruppur to Erode', to: 'Erode', distanceKm: 50, timeHours: 1.1, startingFare: 850 },
      { name: 'Tiruppur to Salem', to: 'Salem', distanceKm: 120, timeHours: 2.25, startingFare: 1800 },
      { name: 'Tiruppur to Ooty', to: 'Ooty', distanceKm: 110, timeHours: 3.5, startingFare: 2800 },
      { name: 'Tiruppur to Munnar', to: 'Munnar', distanceKm: 155, timeHours: 4.5, startingFare: 3400 },
      { name: 'Tiruppur to Chennai', to: 'Chennai', distanceKm: 450, timeHours: 7.75, startingFare: 5200 },
      { name: 'Tiruppur to Bengaluru', to: 'Bengaluru', distanceKm: 310, timeHours: 5.5, startingFare: 4200 },
      { name: 'Tiruppur to Trichy', to: 'Trichy', distanceKm: 190, timeHours: 3.5, startingFare: 2700 },
    ],

    fareTable: [
      { to: 'Coimbatore Airport', distanceKm: 45,  timeHours: 1,    hatchback: 800,  sedan: 950,  suv: 1400 },
      { to: 'Coimbatore City',    distanceKm: 55,  timeHours: 1.25, hatchback: 950,  sedan: 1150, suv: 1600 },
      { to: 'Erode',              distanceKm: 50,  timeHours: 1.1,  hatchback: 850,  sedan: 1050, suv: 1500 },
      { to: 'Salem',              distanceKm: 120, timeHours: 2.25, hatchback: 1800, sedan: 2100, suv: 2950 },
      { to: 'Ooty',               distanceKm: 110, timeHours: 3.5,  hatchback: 2800, sedan: 3200, suv: 4400 },
      { to: 'Bengaluru',          distanceKm: 310, timeHours: 5.5,  hatchback: 4200, sedan: 4800, suv: 6500 },
    ],
...
Geographically, Tiruvallur houses key reservoirs supplying drinking water to Chennai including Poondi Reservoir (Sathyamurthy Sagar), Puzhal Lake, and Pulicat Lake Bird Sanctuary. Transportation is anchored by Tiruvallur Railway Station (TRL), Avadi Station (AVD), Tiruttani Station (TRT), and CTH Road (NH-716), with Chennai International Airport (MAA) located just 42 km east. Whether you are seeking healing at Veeraraghava Swamy Temple, climbing 365 steps at Tiruttani, visiting Avadi HVF defense plants, or taking an express airport transfer to Chennai Airport or Tirupati, SAMAYAS provides reliable 24/7 one-way cabs from Tiruvallur with zero return fare charges.`,
    ...
    routes: [
      { name: 'Tiruvallur to Chennai Airport', to: 'Chennai Airport', distanceKm: 42, timeHours: 1, startingFare: 750 },
      { name: 'Tiruvallur to Tirupati', to: 'Tirupati', distanceKm: 95, timeHours: 2.25, startingFare: 1750 },
      { name: 'Tiruvallur to Tiruttani', to: 'Tiruttani', distanceKm: 30, timeHours: 0.6, startingFare: 550 },
      { name: 'Tiruvallur to Kanchipuram', to: 'Kanchipuram', distanceKm: 40, timeHours: 0.8, startingFare: 700 },
      { name: 'Tiruvallur to Bengaluru', to: 'Bengaluru', distanceKm: 280, timeHours: 5.25, startingFare: 3800 },
      { name: 'Tiruvallur to Vellore', to: 'Vellore', distanceKm: 90, timeHours: 1.75, startingFare: 1450 },
      { name: 'Tiruvallur to Puducherry', to: 'Puducherry', distanceKm: 160, timeHours: 3.25, startingFare: 2400 },
      { name: 'Tiruvallur to Gummidipoondi', to: 'Gummidipoondi', distanceKm: 50, timeHours: 1, startingFare: 850 },
      { name: 'Tiruvallur to Sriperumbudur', to: 'Sriperumbudur', distanceKm: 32, timeHours: 0.6, startingFare: 600 },
    ],

    fareTable: [
      { to: 'Chennai Airport', distanceKm: 42,  timeHours: 1,    hatchback: 750,  sedan: 900,  suv: 1350 },
      { to: 'Tirupati',        distanceKm: 95,  timeHours: 2.25, hatchback: 1750, sedan: 2000, suv: 2800 },
      { to: 'Tiruttani',       distanceKm: 30,  timeHours: 0.6,  hatchback: 550,  sedan: 700,  suv: 1000 },
      { to: 'Kanchipuram',     distanceKm: 40,  timeHours: 0.8,  hatchback: 700,  sedan: 850,  suv: 1250 },
      { to: 'Bengaluru',       distanceKm: 280, timeHours: 5.25, hatchback: 3800, sedan: 4300, suv: 5800 },
      { to: 'Vellore',         distanceKm: 90,  timeHours: 1.75, hatchback: 1450, sedan: 1700, suv: 2400 },
    ],
...
Spiritual seekers worldwide visit Sri Ramana Maharshi Ashram, Virupaksha Cave, Skandashram, Sri Shesadri Swamigal Ashram, and Sri Yogi Ramsuratkumar Ashram. The district is also famous for Arani silk handloom saree weaving and the pristine Jawadhu Hills (Jamunamarathur, Beeman Falls, and Observatory). Transportation is anchored by Tiruvannamalai Railway Station (TNM), Polur Station, and Central Bus Stand on Chengam Road, with Chennai International Airport (MAA) 170 km northeast and Puducherry 105 km east. Whether you are coming for Pournami Girivalam, visiting Ramana Ashram, buying Arani silk sarees, or booking a direct airport transfer to Chennai or Puducherry, SAMAYAS provides reliable 24/7 one-way cabs from Tiruvannamalai with zero return fare charges.`,
    ...
    routes: [
      { name: 'Tiruvannamalai to Chennai Airport', to: 'Chennai Airport', distanceKm: 170, timeHours: 3.5, startingFare: 2600 },
      { name: 'Tiruvannamalai to Puducherry', to: 'Puducherry', distanceKm: 105, timeHours: 2.25, startingFare: 1650 },
      { name: 'Tiruvannamalai to Bengaluru', to: 'Bengaluru', distanceKm: 200, timeHours: 4.25, startingFare: 3000 },
      { name: 'Tiruvannamalai to Vellore', to: 'Vellore', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Tiruvannamalai to Salem', to: 'Salem', distanceKm: 145, timeHours: 2.75, startingFare: 2200 },
      { name: 'Tiruvannamalai to Trichy', to: 'Trichy', distanceKm: 190, timeHours: 3.5, startingFare: 2800 },
      { name: 'Tiruvannamalai to Tirupati', to: 'Tirupati', distanceKm: 195, timeHours: 4, startingFare: 2900 },
      { name: 'Tiruvannamalai to Kanchipuram', to: 'Kanchipuram', distanceKm: 110, timeHours: 2.25, startingFare: 1750 },
      { name: 'Tiruvannamalai to Villupuram', to: 'Villupuram', distanceKm: 60, timeHours: 1.25, startingFare: 950 },
    ],

    fareTable: [
      { to: 'Chennai Airport', distanceKm: 170, timeHours: 3.5,  hatchback: 2600, sedan: 3000, suv: 4200 },
      { to: 'Puducherry',      distanceKm: 105, timeHours: 2.25, hatchback: 1650, sedan: 1900, suv: 2700 },
      { to: 'Bengaluru',       distanceKm: 200, timeHours: 4.25, hatchback: 3000, sedan: 3450, suv: 4800 },
      { to: 'Vellore',         distanceKm: 85,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2300 },
      { to: 'Salem',           distanceKm: 145, timeHours: 2.75, hatchback: 2200, sedan: 2550, suv: 3600 },
      { to: 'Kanchipuram',     distanceKm: 110, timeHours: 2.25, hatchback: 1750, sedan: 2000, suv: 2850 },
    ],
...
Spiritually, Tiruvarur houses the Mannargudi Rajagopalaswamy Temple ('Dakshina Dwarka' with its 154-ft gopuram) and Koothanur Saraswathi Temple—the only dedicated temple in Tamil Nadu for Goddess Saraswathi. Geographically, it hosts the Muthupet Mangrove Wetlands lagoon—part of Point Calimere Sanctuary featuring 120 sq km of pristine mangrove forests and bird havens. Transportation is anchored by Tiruvarur Junction (TVR), Mannargudi Station (MQ), and Tiruvarur Central Bus Stand, with Tiruchirappalli International Airport (TRZ) located 105 km west. Whether you are attending the Azhi Ther festival, visiting the Carnatic Trinity birthplaces, exploring Muthupet mangroves, or booking an outstation taxi to Velankanni, Thanjavur, or Trichy, SAMAYAS provides reliable 24/7 one-way cabs from Tiruvarur with zero return fare charges.`,
    ...
    routes: [
      { name: 'Tiruvarur to Trichy', to: 'Trichy', distanceKm: 105, timeHours: 2, startingFare: 1650 },
      { name: 'Tiruvarur to Thanjavur', to: 'Thanjavur', distanceKm: 55, timeHours: 1, startingFare: 900 },
      { name: 'Tiruvarur to Velankanni', to: 'Velankanni', distanceKm: 30, timeHours: 0.6, startingFare: 550 },
      { name: 'Tiruvarur to Nagapattinam', to: 'Nagapattinam', distanceKm: 25, timeHours: 0.5, startingFare: 500 },
      { name: 'Tiruvarur to Chennai', to: 'Chennai', distanceKm: 320, timeHours: 6, startingFare: 4000 },
      { name: 'Tiruvarur to Kumbakonam', to: 'Kumbakonam', distanceKm: 40, timeHours: 0.8, startingFare: 700 },
      { name: 'Tiruvarur to Madurai', to: 'Madurai', distanceKm: 200, timeHours: 3.75, startingFare: 2800 },
      { name: 'Tiruvarur to Pudukkottai', to: 'Pudukkottai', distanceKm: 95, timeHours: 1.75, startingFare: 1450 },
      { name: 'Tiruvarur to Rameshwaram', to: 'Rameshwaram', distanceKm: 230, timeHours: 4.5, startingFare: 3300 },
    ],

    fareTable: [
      { to: 'Trichy',        distanceKm: 105, timeHours: 2,    hatchback: 1650, sedan: 1900, suv: 2700 },
      { to: 'Thanjavur',     distanceKm: 55,  timeHours: 1,    hatchback: 900,  sedan: 1100, suv: 1550 },
      { to: 'Velankanni',    distanceKm: 30,  timeHours: 0.6,  hatchback: 550,  sedan: 700,  suv: 1000 },
      { to: 'Nagapattinam',  distanceKm: 25,  timeHours: 0.5,  hatchback: 500,  sedan: 650,  suv: 950 },
      { to: 'Chennai',       distanceKm: 320, timeHours: 6,    hatchback: 4000, sedan: 4600, suv: 6300 },
      { to: 'Kumbakonam',    distanceKm: 40,  timeHours: 0.8,  hatchback: 700,  sedan: 850,  suv: 1250 },
    ],
...
Historically, the city is guarded by the 16th-century Vijayanagara granite monolith Vellore Fort, housing the exquisite Jalakanteswarar Temple, St. John's Church, Tipu Mahal, and Government Museum. Vellore is also an educational hub hosting VIT University (Vellore Institute of Technology). Transportation is anchored by Katpadi Junction (KPD)—one of South India's busiest railway hubs on the Chennai-Bengaluru trunk line—Vellore Cantonment (VLR), and Vellore New Bus Stand, with Chennai International Airport (MAA) 130 km east and Bengaluru Airport (BLR) 210 km west. Whether you are traveling for medical consultations at CMC Vellore, visiting VIT University, seeking blessings at Sripuram Golden Temple, or taking an outstation cab to Chennai Airport, Tirupati, or Bengaluru, SAMAYAS provides reliable 24/7 one-way cabs from Vellore with zero return fare charges.`,
    ...
    routes: [
      { name: 'Vellore to Chennai Airport', to: 'Chennai Airport', distanceKm: 130, timeHours: 2.5, startingFare: 2000 },
      { name: 'Vellore to Bengaluru', to: 'Bengaluru', distanceKm: 210, timeHours: 4, startingFare: 3100 },
      { name: 'Vellore to Tirupati', to: 'Tirupati', distanceKm: 110, timeHours: 2.5, startingFare: 1750 },
      { name: 'Vellore to Puducherry', to: 'Puducherry', distanceKm: 155, timeHours: 3.25, startingFare: 2350 },
      { name: 'Vellore to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 85, timeHours: 1.75, startingFare: 1400 },
      { name: 'Vellore to Salem', to: 'Salem', distanceKm: 215, timeHours: 3.75, startingFare: 3200 },
      { name: 'Vellore to Kanchipuram', to: 'Kanchipuram', distanceKm: 70, timeHours: 1.25, startingFare: 1150 },
      { name: 'Vellore to Ranipet', to: 'Ranipet', distanceKm: 30, timeHours: 0.6, startingFare: 550 },
      { name: 'Vellore to Tirupathur', to: 'Tirupathur', distanceKm: 85, timeHours: 1.5, startingFare: 1350 },
    ],

    fareTable: [
      { to: 'Chennai Airport', distanceKm: 130, timeHours: 2.5,  hatchback: 2000, sedan: 2350, suv: 3300 },
      { to: 'Bengaluru',       distanceKm: 210, timeHours: 4,    hatchback: 3100, sedan: 3550, suv: 4900 },
      { to: 'Tirupati',        distanceKm: 110, timeHours: 2.5,  hatchback: 1750, sedan: 2000, suv: 2800 },
      { to: 'Puducherry',      distanceKm: 155, timeHours: 3.25, hatchback: 2350, sedan: 2700, suv: 3750 },
      { to: 'Tiruvannamalai',   distanceKm: 85,  timeHours: 1.75, hatchback: 1400, sedan: 1650, suv: 2300 },
      { to: 'Kanchipuram',     distanceKm: 70,  timeHours: 1.25, hatchback: 1150, sedan: 1350, suv: 1900 },
    ],
...
Viluppuram is world-famous for spiritual landmarks including Melmalayanur Arulmigu Angalamman Temple (renowned for its powerful Amavasai night midnight rituals), Thiruvakkarai Vakkrakali Amman Temple, the 20 Million-Year-Old National Fossil Wood Park at Thiruvakkarai, and the international township of Auroville on the Puducherry border. Transportation is anchored by Villupuram Junction (VM)—one of Southern Railway's largest five-way railway divisions—Tindivanam Junction (TMV), and Central Bus Stand on GST Road, with Puducherry Airport (PNY) just 35 km east and Chennai International Airport (MAA) 140 km north. Whether you are climbing Gingee Fort, attending Melmalayanur Amavasai, visiting Auroville, or booking a direct airport transfer to Puducherry or Chennai, SAMAYAS provides reliable 24/7 one-way cabs from Viluppuram with zero return fare charges.`,
    ...
    routes: [
      { name: 'Viluppuram to Puducherry', to: 'Puducherry', distanceKm: 38, timeHours: 0.75, startingFare: 650 },
      { name: 'Viluppuram to Chennai Airport', to: 'Chennai Airport', distanceKm: 140, timeHours: 2.75, startingFare: 2200 },
      { name: 'Viluppuram to Trichy', to: 'Trichy', distanceKm: 160, timeHours: 2.75, startingFare: 2300 },
      { name: 'Viluppuram to Tiruvannamalai', to: 'Tiruvannamalai', distanceKm: 60, timeHours: 1.25, startingFare: 950 },
      { name: 'Viluppuram to Cuddalore', to: 'Cuddalore', distanceKm: 45, timeHours: 0.9, startingFare: 750 },
      { name: 'Viluppuram to Gingee Fort', to: 'Gingee Fort', distanceKm: 40, timeHours: 0.75, startingFare: 700 },
      { name: 'Viluppuram to Salem', to: 'Salem', distanceKm: 170, timeHours: 3.25, startingFare: 2600 },
      { name: 'Viluppuram to Madurai', to: 'Madurai', distanceKm: 280, timeHours: 4.75, startingFare: 4000 },
      { name: 'Viluppuram to Kallakurichi', to: 'Kallakurichi', distanceKm: 65, timeHours: 1.25, startingFare: 1050 },
    ],

    fareTable: [
      { to: 'Puducherry',      distanceKm: 38,  timeHours: 0.75, hatchback: 650,  sedan: 800,  suv: 1200 },
      { to: 'Chennai Airport', distanceKm: 140, timeHours: 2.75, hatchback: 2200, sedan: 2550, suv: 3600 },
      { to: 'Trichy',          distanceKm: 160, timeHours: 2.75, hatchback: 2300, sedan: 2650, suv: 3700 },
      { to: 'Tiruvannamalai',   distanceKm: 60,  timeHours: 1.25, hatchback: 950,  sedan: 1150, suv: 1600 },
      { to: 'Cuddalore',       distanceKm: 45,  timeHours: 0.9,  hatchback: 750,  sedan: 900,  suv: 1300 },
      { to: 'Gingee Fort',     distanceKm: 40,  timeHours: 0.75, hatchback: 700,  sedan: 850,  suv: 1250 },
    ],
...
Industrial hubs extend to Rajapalayam (famous for surgical cotton manufacturing, Rajapalayam hound dogs, and Ayyanar Falls) and Aruppukottai textile mills. Nature lovers explore Srivilliputhur Grizzled Giant Squirrel Wildlife Sanctuary in the Western Ghats. Transportation is anchored by Virudhunagar Junction (VPT), Sivakasi Station (SVKS), Rajapalayam Station (RJPM), and Central Bus Stand on NH-44, with Madurai International Airport (IXM) located just 45 km north. Whether you are buying fireworks in Sivakasi, visiting Kamarajar Memorial, seeking blessings at Srivilliputhur Andal Temple, tasting Palkova, or booking a direct airport transfer to Madurai Airport, SAMAYAS provides reliable 24/7 one-way cabs from Virudhunagar with zero return fare charges.`,
    ...
    routes: [
      { name: 'Virudhunagar to Madurai Airport', to: 'Madurai Airport', distanceKm: 45, timeHours: 0.8, startingFare: 800 },
      { name: 'Virudhunagar to Sivakasi', to: 'Sivakasi', distanceKm: 25, timeHours: 0.5, startingFare: 500 },
      { name: 'Virudhunagar to Srivilliputhur', to: 'Srivilliputhur', distanceKm: 45, timeHours: 0.8, startingFare: 800 },
      { name: 'Virudhunagar to Rajapalayam', to: 'Rajapalayam', distanceKm: 55, timeHours: 1.1, startingFare: 950 },
      { name: 'Virudhunagar to Tirunelveli', to: 'Tirunelveli', distanceKm: 100, timeHours: 1.75, startingFare: 1550 },
      { name: 'Virudhunagar to Kanyakumari', to: 'Kanyakumari', distanceKm: 185, timeHours: 3.25, startingFare: 2750 },
      { name: 'Virudhunagar to Chennai', to: 'Chennai', distanceKm: 530, timeHours: 8.5, startingFare: 6300 },
      { name: 'Virudhunagar to Rameshwaram', to: 'Rameshwaram', distanceKm: 165, timeHours: 3.25, startingFare: 2450 },
      { name: 'Virudhunagar to Coimbatore', to: 'Coimbatore', distanceKm: 220, timeHours: 4.5, startingFare: 3300 },
    ],

    fareTable: [
      { to: 'Madurai Airport', distanceKm: 45,  timeHours: 0.8,  hatchback: 800,  sedan: 950,  suv: 1400 },
      { to: 'Sivakasi',        distanceKm: 25,  timeHours: 0.5,  hatchback: 500,  sedan: 650,  suv: 950 },
      { to: 'Srivilliputhur',  distanceKm: 45,  timeHours: 0.8,  hatchback: 800,  sedan: 950,  suv: 1400 },
      { to: 'Rajapalayam',     distanceKm: 55,  timeHours: 1.1,  hatchback: 950,  sedan: 1150, suv: 1600 },
      { to: 'Tirunelveli',     distanceKm: 100, timeHours: 1.75, hatchback: 1550, sedan: 1800, suv: 2550 },
      { to: 'Chennai',         distanceKm: 530, timeHours: 8.5,  hatchback: 6300, sedan: 7200, suv: 9800 },
    ],
