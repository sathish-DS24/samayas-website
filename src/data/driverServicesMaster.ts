export interface DriverServiceMasterItem {
  id: string;
  slug: string;
  serviceName: string;
  shortName: string;
...
export const driverServicesDataset: DriverServiceMasterItem[] = [
  {
    id: 'hourly-driver',
    slug: 'hourly-driver',
...
export function getDriverServiceBySlug(slug?: string): DriverServiceMasterItem | null {
  if (!slug) return null;
