export interface RecoveryServiceItem {
  id: string;
  slug: string;
  serviceName: string;
  shortName: string;
...
export const recoveryServicesDataset: RecoveryServiceItem[] = [
  {
    id: 'car-recovery',
    slug: 'car-recovery',
...
export function getRecoveryServiceBySlug(slug?: string): RecoveryServiceItem | null {
  if (!slug) return null;
