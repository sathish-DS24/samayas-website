export interface TourPackage {
  ...
  originCity?: string // e.g. 'Coimbatore', 'Chennai', 'Bangalore', 'Madurai', 'Trichy'
  startingPrice: number // e.g. 4500
  heroImage: string
  overview: string
  idealFor: string[] // e.g. ['Families', 'Couples', 'Weekend Travellers']
  itinerary: Array<{
    day: number
    title: string
    activities: string[]
...
export const tourPackagesDataset: TourPackage[] = [
  {
    id: 'ooty-2-days',
    slug: 'ooty-2-days',
